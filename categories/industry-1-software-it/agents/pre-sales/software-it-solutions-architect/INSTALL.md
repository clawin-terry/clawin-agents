...
```text
~/.openclaw/agents/software-it-solutions-architect
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-solutions-architect`.
2. Open `config/openclaw.agent.software-it-solutions-architect.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-solutions-architect.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-solutions-architect/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-solutions-architect/workspace`
- agentDir: `~/.openclaw/agents/software-it-solutions-architect/agent`
