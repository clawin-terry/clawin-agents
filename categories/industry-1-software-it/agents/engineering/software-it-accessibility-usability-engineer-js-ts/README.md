# Accessibility and Usability Engineer (JS/TS)

A shareable OpenClaw agent folder package for **Accessibility and Usability Engineer (JS/TS)**.

## Package identity
- Agent ID: `software-it-accessibility-usability-engineer-js-ts`
