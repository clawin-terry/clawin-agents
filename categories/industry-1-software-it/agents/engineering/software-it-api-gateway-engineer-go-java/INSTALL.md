# Install API Gateway Engineer (Go/Java)
...
```text
~/.openclaw/agents/software-it-api-gateway-engineer-go-java
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-api-gateway-engineer-go-java`.
2. Open `config/openclaw.agent.software-it-api-gateway-engineer-go-java.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-api-gateway-engineer-go-java.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-api-gateway-engineer-go-java/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-api-gateway-engineer-go-java/workspace`
- agentDir: `~/.openclaw/agents/software-it-api-gateway-engineer-go-java/agent`
