# Install iOS Engineer (Swift/Objective-C)
...
```text
~/.openclaw/agents/software-it-ios-engineer-swift-objc
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-ios-engineer-swift-objc`.
2. Open `config/openclaw.agent.software-it-ios-engineer-swift-objc.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-ios-engineer-swift-objc.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-ios-engineer-swift-objc/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-ios-engineer-swift-objc/workspace`
- agentDir: `~/.openclaw/agents/software-it-ios-engineer-swift-objc/agent`
