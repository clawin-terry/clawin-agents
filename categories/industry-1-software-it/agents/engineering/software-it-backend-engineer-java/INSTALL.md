...
```text
~/.openclaw/agents/software-it-backend-engineer-java
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-backend-engineer-java`.
2. Open `config/openclaw.agent.software-it-backend-engineer-java.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-backend-engineer-java.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-backend-engineer-java/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-backend-engineer-java/workspace`
- agentDir: `~/.openclaw/agents/software-it-backend-engineer-java/agent`
