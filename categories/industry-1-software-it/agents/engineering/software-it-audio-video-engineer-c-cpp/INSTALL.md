# Install Audio and Video Engineer (C/C++)
...
```text
~/.openclaw/agents/software-it-audio-video-engineer-c-cpp
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-audio-video-engineer-c-cpp`.
2. Open `config/openclaw.agent.software-it-audio-video-engineer-c-cpp.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-audio-video-engineer-c-cpp.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-audio-video-engineer-c-cpp/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-audio-video-engineer-c-cpp/workspace`
- agentDir: `~/.openclaw/agents/software-it-audio-video-engineer-c-cpp/agent`
