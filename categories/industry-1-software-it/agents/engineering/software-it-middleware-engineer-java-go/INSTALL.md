# Install Middleware Engineer (Java/Go)
...
```text
~/.openclaw/agents/software-it-middleware-engineer-java-go
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-middleware-engineer-java-go`.
2. Open `config/openclaw.agent.software-it-middleware-engineer-java-go.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-middleware-engineer-java-go.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-middleware-engineer-java-go/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-middleware-engineer-java-go/workspace`
- agentDir: `~/.openclaw/agents/software-it-middleware-engineer-java-go/agent`
