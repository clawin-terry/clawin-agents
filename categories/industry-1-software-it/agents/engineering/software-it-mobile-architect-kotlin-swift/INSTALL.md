# Install Mobile Architect (Kotlin/Swift)
...
```text
~/.openclaw/agents/software-it-mobile-architect-kotlin-swift
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-mobile-architect-kotlin-swift`.
2. Open `config/openclaw.agent.software-it-mobile-architect-kotlin-swift.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-mobile-architect-kotlin-swift.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-mobile-architect-kotlin-swift/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-mobile-architect-kotlin-swift/workspace`
- agentDir: `~/.openclaw/agents/software-it-mobile-architect-kotlin-swift/agent`
