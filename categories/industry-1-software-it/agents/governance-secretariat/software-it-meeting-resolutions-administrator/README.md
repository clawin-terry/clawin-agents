# Meeting and Resolutions Administrator

A shareable OpenClaw agent folder package for **Meeting and Resolutions Administrator**.

## Package identity
- Agent ID: `software-it-meeting-resolutions-administrator`
- Industry: `industry-1-software-it`
- Role family: `governance-secretariat`
