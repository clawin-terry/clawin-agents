# Delivery Invoicing Coordination Specialist

A shareable OpenClaw agent folder package for **Delivery Invoicing Coordination Specialist**.

## Package identity
- Agent ID: `software-it-delivery-invoicing-coordination-specialist`
- Industry: `industry-1-software-it`
- Role family: `commercial-support`
