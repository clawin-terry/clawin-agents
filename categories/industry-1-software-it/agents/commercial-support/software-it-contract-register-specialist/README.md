# Contract Register Specialist

A shareable OpenClaw agent folder package for **Contract Register Specialist**.

## Package identity
- Agent ID: `software-it-contract-register-specialist`
