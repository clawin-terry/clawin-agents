# Collections Follow-Up Specialist

A shareable OpenClaw agent folder package for **Collections Follow-Up Specialist**.

## Package identity
- Agent ID: `software-it-collections-follow-up-specialist`
