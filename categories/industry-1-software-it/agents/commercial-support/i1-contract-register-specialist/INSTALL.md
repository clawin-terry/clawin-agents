...
```text
~/.openclaw/agents/i1-contract-register-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i1-contract-register-specialist`.
2. Open `config/openclaw.agent.i1-contract-register-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i1-contract-register-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i1-contract-register-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i1-contract-register-specialist/workspace`
- agentDir: `~/.openclaw/agents/i1-contract-register-specialist/agent`
