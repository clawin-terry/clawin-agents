# Install Platform Architect (Java/Go)
...
```text
~/.openclaw/agents/software-it-platform-architect-java-go
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-platform-architect-java-go`.
2. Open `config/openclaw.agent.software-it-platform-architect-java-go.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-platform-architect-java-go.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-platform-architect-java-go/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-platform-architect-java-go/workspace`
- agentDir: `~/.openclaw/agents/software-it-platform-architect-java-go/agent`
