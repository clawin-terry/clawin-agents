# Middleware Integration Engineer (Java)

A shareable OpenClaw agent folder package for **Middleware Integration Engineer (Java)**.

## Package identity
- Agent ID: `software-it-middleware-integration-engineer-java`
- Industry: `industry-1-software-it`
- Role family: `integration`
