# Lead Nurturing Operations Manager

A shareable OpenClaw agent folder package for **Lead Nurturing Operations Manager**.

## Package identity
- Agent ID: `software-it-lead-nurturing-operations-manager`
- Industry: `industry-1-software-it`
- Role family: `digital-marketing`
