# Data Assets and Catalog Administrator

A shareable OpenClaw agent folder package for **Data Assets and Catalog Administrator**.

## Package identity
- Agent ID: `software-it-data-assets-and-catalog-administrator`
