# Privacy Compliance Manager (PIPL / GDPR)

A shareable OpenClaw agent folder package for **Privacy Compliance Manager (PIPL / GDPR)**.

## Package identity
- Agent ID: `software-it-privacy-compliance-manager-pipl-gdpr`
