# Install Data Protection Officer (DPO)
...
```text
~/.openclaw/agents/software-it-data-protection-officer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-data-protection-officer`.
2. Open `config/openclaw.agent.software-it-data-protection-officer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-data-protection-officer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-data-protection-officer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-data-protection-officer/workspace`
- agentDir: `~/.openclaw/agents/software-it-data-protection-officer/agent`
