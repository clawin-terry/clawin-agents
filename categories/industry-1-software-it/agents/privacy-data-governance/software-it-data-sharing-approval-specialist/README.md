# Data Sharing Approval Specialist

A shareable OpenClaw agent folder package for **Data Sharing Approval Specialist**.

## Package identity
- Agent ID: `software-it-data-sharing-approval-specialist`
