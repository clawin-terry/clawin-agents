# Install Customer Training Instructor
...
```text
~/.openclaw/agents/software-it-customer-training-instructor
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-customer-training-instructor`.
2. Open `config/openclaw.agent.software-it-customer-training-instructor.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-customer-training-instructor.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-customer-training-instructor/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-customer-training-instructor/workspace`
- agentDir: `~/.openclaw/agents/software-it-customer-training-instructor/agent`
