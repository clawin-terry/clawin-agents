# Certification Exam Operations Manager

A shareable OpenClaw agent folder package for **Certification Exam Operations Manager**.

## Package identity
- Agent ID: `software-it-certification-exam-operations-manager`
