# Strategy Execution PM (OKR / Annual Planning)

A shareable OpenClaw agent folder package for **Strategy Execution PM (OKR / Annual Planning)**.

## Package identity
- Agent ID: `software-it-strategy-execution-pm`
