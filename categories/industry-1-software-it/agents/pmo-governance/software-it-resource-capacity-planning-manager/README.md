# Resource and Capacity Planning Manager

A shareable OpenClaw agent folder package for **Resource and Capacity Planning Manager**.

## Package identity
- Agent ID: `software-it-resource-capacity-planning-manager`
