# Milestone and Risk Control Specialist

A shareable OpenClaw agent folder package for **Milestone and Risk Control Specialist**.

## Package identity
- Agent ID: `software-it-milestone-risk-control-specialist`
