# Policy and Meeting Management Specialist

A shareable OpenClaw agent folder package for **Policy and Meeting Management Specialist**.

## Package identity
- Agent ID: `software-it-policy-meeting-management-specialist`
- Industry: `industry-1-software-it`
- Role family: `business-operations`
