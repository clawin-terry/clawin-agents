# CEO Assistant / Special Assistant

A shareable OpenClaw agent folder package for **CEO Assistant / Special Assistant**.

## Package identity
- Agent ID: `software-it-ceo-assistant-special-assistant`
