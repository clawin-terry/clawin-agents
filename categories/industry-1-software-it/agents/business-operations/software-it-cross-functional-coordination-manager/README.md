# Cross-Functional Coordination Manager

A shareable OpenClaw agent folder package for **Cross-Functional Coordination Manager**.

## Package identity
- Agent ID: `software-it-cross-functional-coordination-manager`
