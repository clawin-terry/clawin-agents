# Install Head of Business Intelligence
...
```text
~/.openclaw/agents/software-it-head-of-business-intelligence
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-head-of-business-intelligence`.
2. Open `config/openclaw.agent.software-it-head-of-business-intelligence.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-head-of-business-intelligence.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-head-of-business-intelligence/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-head-of-business-intelligence/workspace`
- agentDir: `~/.openclaw/agents/software-it-head-of-business-intelligence/agent`
