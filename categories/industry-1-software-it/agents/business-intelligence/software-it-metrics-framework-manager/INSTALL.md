# Install Metrics Framework Manager
...
```text
~/.openclaw/agents/software-it-metrics-framework-manager
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-metrics-framework-manager`.
2. Open `config/openclaw.agent.software-it-metrics-framework-manager.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-metrics-framework-manager.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-metrics-framework-manager/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-metrics-framework-manager/workspace`
- agentDir: `~/.openclaw/agents/software-it-metrics-framework-manager/agent`
