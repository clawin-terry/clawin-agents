...
```text
~/.openclaw/agents/i1-computer-vision-engineer-python
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i1-computer-vision-engineer-python`.
2. Open `config/openclaw.agent.i1-computer-vision-engineer-python.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i1-computer-vision-engineer-python.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i1-computer-vision-engineer-python/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i1-computer-vision-engineer-python/workspace`
- agentDir: `~/.openclaw/agents/i1-computer-vision-engineer-python/agent`
