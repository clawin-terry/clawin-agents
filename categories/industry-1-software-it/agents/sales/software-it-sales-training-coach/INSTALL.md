...
```text
~/.openclaw/agents/software-it-sales-training-coach
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-sales-training-coach`.
2. Open `config/openclaw.agent.software-it-sales-training-coach.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-sales-training-coach.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-sales-training-coach/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-sales-training-coach/workspace`
- agentDir: `~/.openclaw/agents/software-it-sales-training-coach/agent`
