# Retrospective and Improvement Specialist

A shareable OpenClaw agent folder package for **Retrospective and Improvement Specialist**.

## Package identity
- Agent ID: `software-it-retrospective-improvement-specialist`
