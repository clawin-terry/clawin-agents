# Voice of Customer Operations Manager

A shareable OpenClaw agent folder package for **Voice of Customer Operations Manager**.

## Package identity
- Agent ID: `software-it-voice-of-customer-operations-manager`
