# Major Customer Complaint Response Lead

A shareable OpenClaw agent folder package for **Major Customer Complaint Response Lead**.

## Package identity
- Agent ID: `software-it-major-customer-complaint-response-lead`
- Industry: `industry-1-software-it`
- Role family: `customer-complaints-quality`
