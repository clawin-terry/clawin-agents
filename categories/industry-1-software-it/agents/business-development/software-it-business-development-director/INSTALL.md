# Install Business Development Director
...
```text
~/.openclaw/agents/software-it-business-development-director
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-business-development-director`.
2. Open `config/openclaw.agent.software-it-business-development-director.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-business-development-director.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-business-development-director/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-business-development-director/workspace`
- agentDir: `~/.openclaw/agents/software-it-business-development-director/agent`
