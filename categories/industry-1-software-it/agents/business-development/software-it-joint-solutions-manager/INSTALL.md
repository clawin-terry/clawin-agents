# Install Joint Solutions Manager
...
```text
~/.openclaw/agents/software-it-joint-solutions-manager
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-joint-solutions-manager`.
2. Open `config/openclaw.agent.software-it-joint-solutions-manager.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-joint-solutions-manager.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-joint-solutions-manager/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-joint-solutions-manager/workspace`
- agentDir: `~/.openclaw/agents/software-it-joint-solutions-manager/agent`
