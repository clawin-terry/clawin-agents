# Process Digitization (BPM) Product Manager

A shareable OpenClaw agent folder package for **Process Digitization (BPM) Product Manager**.

## Package identity
- Agent ID: `software-it-bpm-product-manager`
