# Social Insurance and Housing Fund Specialist

A shareable OpenClaw agent folder package for **Social Insurance and Housing Fund Specialist**.

## Package identity
- Agent ID: `software-it-social-insurance-housing-fund-specialist`
