# Install Visual and Creative Planner
...
```text
~/.openclaw/agents/software-it-visual-creative-planner
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-visual-creative-planner`.
2. Open `config/openclaw.agent.software-it-visual-creative-planner.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-visual-creative-planner.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-visual-creative-planner/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-visual-creative-planner/workspace`
- agentDir: `~/.openclaw/agents/software-it-visual-creative-planner/agent`
