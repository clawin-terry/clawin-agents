# Install Video and Multimedia Producer
...
```text
~/.openclaw/agents/software-it-video-multimedia-producer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-video-multimedia-producer`.
2. Open `config/openclaw.agent.software-it-video-multimedia-producer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-video-multimedia-producer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-video-multimedia-producer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-video-multimedia-producer/workspace`
- agentDir: `~/.openclaw/agents/software-it-video-multimedia-producer/agent`
