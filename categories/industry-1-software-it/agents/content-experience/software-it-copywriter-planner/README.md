# Copywriter and Content Planner

A shareable OpenClaw agent folder package for **Copywriter and Content Planner**.

## Package identity
- Agent ID: `software-it-copywriter-planner`
- Industry: `industry-1-software-it`
- Role family: `content-experience`
