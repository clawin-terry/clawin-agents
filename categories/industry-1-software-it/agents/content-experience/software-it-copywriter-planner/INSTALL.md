# Install Copywriter and Content Planner
...
```text
~/.openclaw/agents/software-it-copywriter-planner
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-copywriter-planner`.
2. Open `config/openclaw.agent.software-it-copywriter-planner.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-copywriter-planner.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-copywriter-planner/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-copywriter-planner/workspace`
- agentDir: `~/.openclaw/agents/software-it-copywriter-planner/agent`
