...
```text
~/.openclaw/agents/software-it-docs-ux-editor
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-docs-ux-editor`.
2. Open `config/openclaw.agent.software-it-docs-ux-editor.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-docs-ux-editor.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-docs-ux-editor/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-docs-ux-editor/workspace`
- agentDir: `~/.openclaw/agents/software-it-docs-ux-editor/agent`
