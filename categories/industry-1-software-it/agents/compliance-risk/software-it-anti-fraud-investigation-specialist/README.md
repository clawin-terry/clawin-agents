# Anti-Fraud Investigation Specialist

A shareable OpenClaw agent folder package for **Anti-Fraud Investigation Specialist**.

## Package identity
- Agent ID: `software-it-anti-fraud-investigation-specialist`
