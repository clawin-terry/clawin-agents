# Gifts, Hospitality, and Conflict of Interest Specialist

A shareable OpenClaw agent folder package for **Gifts, Hospitality, and Conflict of Interest Specialist**.

## Package identity
- Agent ID: `software-it-gifts-hospitality-conflict-of-interest-specialist`
