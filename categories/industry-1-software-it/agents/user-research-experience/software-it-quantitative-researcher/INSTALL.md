# Install Quantitative Researcher
...
```text
~/.openclaw/agents/software-it-quantitative-researcher
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-quantitative-researcher`.
2. Open `config/openclaw.agent.software-it-quantitative-researcher.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-quantitative-researcher.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-quantitative-researcher/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-quantitative-researcher/workspace`
- agentDir: `~/.openclaw/agents/software-it-quantitative-researcher/agent`
