# Logging and Audit Trail Specialist

A shareable OpenClaw agent folder package for **Logging and Audit Trail Specialist**.

## Package identity
- Agent ID: `software-it-logging-and-audit-trail-specialist`
