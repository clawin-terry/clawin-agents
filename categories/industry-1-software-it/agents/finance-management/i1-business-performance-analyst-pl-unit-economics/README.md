# Business Performance Analyst (P&L / Unit Economics)

A shareable OpenClaw agent folder package for **Business Performance Analyst (P&L / Unit Economics)**.

## Package identity
- Agent ID: `i1-business-performance-analyst-pl-unit-economics`
