# Install Finance Business Partner
...
```text
~/.openclaw/agents/software-it-finance-business-partner
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-finance-business-partner`.
2. Open `config/openclaw.agent.software-it-finance-business-partner.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-finance-business-partner.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-finance-business-partner/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-finance-business-partner/workspace`
- agentDir: `~/.openclaw/agents/software-it-finance-business-partner/agent`
