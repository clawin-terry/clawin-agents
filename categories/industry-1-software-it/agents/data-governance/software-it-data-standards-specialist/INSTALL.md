# Install Data Standards Specialist
...
```text
~/.openclaw/agents/software-it-data-standards-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-data-standards-specialist`.
2. Open `config/openclaw.agent.software-it-data-standards-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-data-standards-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-data-standards-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-data-standards-specialist/workspace`
- agentDir: `~/.openclaw/agents/software-it-data-standards-specialist/agent`
