# Customer Community and Events Operations Manager

A shareable OpenClaw agent folder package for **Customer Community and Events Operations Manager**.

## Package identity
- Agent ID: `software-it-customer-community-events-operations-manager`
