# Settlement and Reconciliation Operations Specialist

A shareable OpenClaw agent folder package for **Settlement and Reconciliation Operations Specialist**.

## Package identity
- Agent ID: `software-it-settlement-reconciliation-operations-specialist`
- Industry: `industry-1-software-it`
- Role family: `commercial-operations`
