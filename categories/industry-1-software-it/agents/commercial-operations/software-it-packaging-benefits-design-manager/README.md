# Packaging and Benefits Design Manager

A shareable OpenClaw agent folder package for **Packaging and Benefits Design Manager**.

## Package identity
- Agent ID: `software-it-packaging-benefits-design-manager`
