# Defect Management Specialist

A shareable OpenClaw agent folder package for **Defect Management Specialist**.

## Package identity
- Agent ID: `software-it-defect-management-specialist`
- Industry: `industry-1-software-it`
- Role family: `quality-assurance`
