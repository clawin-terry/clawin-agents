...
```text
~/.openclaw/agents/software-it-technical-evangelist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-technical-evangelist`.
2. Open `config/openclaw.agent.software-it-technical-evangelist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-technical-evangelist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-technical-evangelist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-technical-evangelist/workspace`
- agentDir: `~/.openclaw/agents/software-it-technical-evangelist/agent`
