# Ecosystem Events Manager

A shareable OpenClaw agent folder package for **Ecosystem Events Manager**.

## Package identity
- Agent ID: `software-it-ecosystem-events-manager`
- Industry: `industry-1-software-it`
- Role family: `ecosystem-operations`
