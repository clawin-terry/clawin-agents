# Install Technical Content Writer
...
```text
~/.openclaw/agents/software-it-technical-content-writer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-technical-content-writer`.
2. Open `config/openclaw.agent.software-it-technical-content-writer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-technical-content-writer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-technical-content-writer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-technical-content-writer/workspace`
- agentDir: `~/.openclaw/agents/software-it-technical-content-writer/agent`
