# Install Lakehouse Engineer (Java/Scala)
...
```text
~/.openclaw/agents/software-it-lakehouse-engineer-java-scala
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-lakehouse-engineer-java-scala`.
2. Open `config/openclaw.agent.software-it-lakehouse-engineer-java-scala.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-lakehouse-engineer-java-scala.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-lakehouse-engineer-java-scala/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-lakehouse-engineer-java-scala/workspace`
- agentDir: `~/.openclaw/agents/software-it-lakehouse-engineer-java-scala/agent`
