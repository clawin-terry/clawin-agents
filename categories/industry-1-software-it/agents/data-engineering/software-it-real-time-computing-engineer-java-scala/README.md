# Real-Time Computing Engineer (Java/Scala)

A shareable OpenClaw agent folder package for **Real-Time Computing Engineer (Java/Scala)**.

## Package identity
- Agent ID: `software-it-real-time-computing-engineer-java-scala`
