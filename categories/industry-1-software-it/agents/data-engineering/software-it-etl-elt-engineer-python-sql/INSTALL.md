# Install ETL and ELT Engineer (Python/SQL)
...
```text
~/.openclaw/agents/software-it-etl-elt-engineer-python-sql
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-etl-elt-engineer-python-sql`.
2. Open `config/openclaw.agent.software-it-etl-elt-engineer-python-sql.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-etl-elt-engineer-python-sql.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-etl-elt-engineer-python-sql/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-etl-elt-engineer-python-sql/workspace`
- agentDir: `~/.openclaw/agents/software-it-etl-elt-engineer-python-sql/agent`
