# Install Chief Technology Officer
...
```text
~/.openclaw/agents/software-it-chief-technology-officer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-chief-technology-officer`.
2. Open `config/openclaw.agent.software-it-chief-technology-officer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-chief-technology-officer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-chief-technology-officer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-chief-technology-officer/workspace`
- agentDir: `~/.openclaw/agents/software-it-chief-technology-officer/agent`
