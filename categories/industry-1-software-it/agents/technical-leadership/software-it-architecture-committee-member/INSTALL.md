# Install Architecture Committee Member
...
```text
~/.openclaw/agents/software-it-architecture-committee-member
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-architecture-committee-member`.
2. Open `config/openclaw.agent.software-it-architecture-committee-member.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-architecture-committee-member.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-architecture-committee-member/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-architecture-committee-member/workspace`
- agentDir: `~/.openclaw/agents/software-it-architecture-committee-member/agent`
