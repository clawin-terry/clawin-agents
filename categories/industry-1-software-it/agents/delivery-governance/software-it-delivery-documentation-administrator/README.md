# Delivery Documentation Administrator

A shareable OpenClaw agent folder package for **Delivery Documentation Administrator**.

## Package identity
- Agent ID: `software-it-delivery-documentation-administrator`
- Industry: `industry-1-software-it`
- Role family: `delivery-governance`
