# Acceptance and Milestone Specialist

A shareable OpenClaw agent folder package for **Acceptance and Milestone Specialist**.

## Package identity
- Agent ID: `software-it-acceptance-milestone-specialist`
