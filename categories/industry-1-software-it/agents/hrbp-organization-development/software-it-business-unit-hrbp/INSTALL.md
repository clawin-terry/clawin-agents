...
```text
~/.openclaw/agents/software-it-business-unit-hrbp
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-business-unit-hrbp`.
2. Open `config/openclaw.agent.software-it-business-unit-hrbp.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-business-unit-hrbp.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-business-unit-hrbp/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-business-unit-hrbp/workspace`
- agentDir: `~/.openclaw/agents/software-it-business-unit-hrbp/agent`
