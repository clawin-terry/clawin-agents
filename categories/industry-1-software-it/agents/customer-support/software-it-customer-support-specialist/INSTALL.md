# Install Customer Support Specialist
...
```text
~/.openclaw/agents/software-it-customer-support-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-customer-support-specialist`.
2. Open `config/openclaw.agent.software-it-customer-support-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-customer-support-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-customer-support-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-customer-support-specialist/workspace`
- agentDir: `~/.openclaw/agents/software-it-customer-support-specialist/agent`
