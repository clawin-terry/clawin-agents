...
```text
~/.openclaw/agents/i1-support-shift-coordinator
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i1-support-shift-coordinator`.
2. Open `config/openclaw.agent.i1-support-shift-coordinator.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i1-support-shift-coordinator.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i1-support-shift-coordinator/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i1-support-shift-coordinator/workspace`
- agentDir: `~/.openclaw/agents/i1-support-shift-coordinator/agent`
