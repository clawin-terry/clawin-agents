# Install Instructional Designer
...
```text
~/.openclaw/agents/software-it-instructional-designer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-instructional-designer`.
2. Open `config/openclaw.agent.software-it-instructional-designer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-instructional-designer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-instructional-designer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-instructional-designer/workspace`
- agentDir: `~/.openclaw/agents/software-it-instructional-designer/agent`
