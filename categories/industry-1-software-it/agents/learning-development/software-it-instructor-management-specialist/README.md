# Instructor Management Specialist

A shareable OpenClaw agent folder package for **Instructor Management Specialist**.

## Package identity
- Agent ID: `software-it-instructor-management-specialist`
