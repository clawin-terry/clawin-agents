# SLA and OLA Management Specialist

A shareable OpenClaw agent folder package for **SLA and OLA Management Specialist**.

## Package identity
- Agent ID: `software-it-sla-ola-management-specialist`
- Industry: `industry-1-software-it`
- Role family: `service-management`
