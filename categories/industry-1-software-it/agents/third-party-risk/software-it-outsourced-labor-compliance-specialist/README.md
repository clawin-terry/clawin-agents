# Outsourced Labor Compliance Specialist

A shareable OpenClaw agent folder package for **Outsourced Labor Compliance Specialist**.

## Package identity
- Agent ID: `software-it-outsourced-labor-compliance-specialist`
- Industry: `industry-1-software-it`
- Role family: `third-party-risk`
