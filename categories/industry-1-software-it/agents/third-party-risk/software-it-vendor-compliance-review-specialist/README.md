# Vendor Compliance Review Specialist

A shareable OpenClaw agent folder package for **Vendor Compliance Review Specialist**.

## Package identity
- Agent ID: `software-it-vendor-compliance-review-specialist`
