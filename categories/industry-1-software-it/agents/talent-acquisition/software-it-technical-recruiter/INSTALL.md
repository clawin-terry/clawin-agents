# Install Technical Recruiter (TA)
...
```text
~/.openclaw/agents/software-it-technical-recruiter
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-technical-recruiter`.
2. Open `config/openclaw.agent.software-it-technical-recruiter.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-technical-recruiter.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-technical-recruiter/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-technical-recruiter/workspace`
- agentDir: `~/.openclaw/agents/software-it-technical-recruiter/agent`
