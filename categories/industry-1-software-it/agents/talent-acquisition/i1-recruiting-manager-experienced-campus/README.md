# Recruiting Manager (Experienced / Campus)

A shareable OpenClaw agent folder package for **Recruiting Manager (Experienced / Campus)**.

## Package identity
- Agent ID: `i1-recruiting-manager-experienced-campus`
