# Foreign Exchange and Cross-Border Settlement Specialist

A shareable OpenClaw agent folder package for **Foreign Exchange and Cross-Border Settlement Specialist**.

## Package identity
- Agent ID: `software-it-foreign-exchange-cross-border-settlement-specialist`
