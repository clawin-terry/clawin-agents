# Install Expense Review Specialist
...
```text
~/.openclaw/agents/software-it-expense-review-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-expense-review-specialist`.
2. Open `config/openclaw.agent.software-it-expense-review-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-expense-review-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-expense-review-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-expense-review-specialist/workspace`
- agentDir: `~/.openclaw/agents/software-it-expense-review-specialist/agent`
