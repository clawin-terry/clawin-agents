# Expense Control Product and Operations Manager

A shareable OpenClaw agent folder package for **Expense Control Product and Operations Manager**.

## Package identity
- Agent ID: `software-it-expense-control-product-operations-manager`
- Industry: `industry-1-software-it`
- Role family: `finance-shared-services`
