# Legal Operations Specialist (Registers / Company Seals)

A shareable OpenClaw agent folder package for **Legal Operations Specialist (Registers / Company Seals)**.

## Package identity
- Agent ID: `software-it-legal-operations-specialist`
