# Office Space and Workstation Manager

A shareable OpenClaw agent folder package for **Office Space and Workstation Manager**.

## Package identity
- Agent ID: `software-it-office-space-workstation-manager`
