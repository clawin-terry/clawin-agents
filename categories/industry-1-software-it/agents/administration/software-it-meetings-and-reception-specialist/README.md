# Meetings and Reception Specialist

A shareable OpenClaw agent folder package for **Meetings and Reception Specialist**.

## Package identity
- Agent ID: `software-it-meetings-and-reception-specialist`
