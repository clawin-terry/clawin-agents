# Install Accounts Payable Accountant
...
```text
~/.openclaw/agents/software-it-accounts-payable-accountant
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-accounts-payable-accountant`.
2. Open `config/openclaw.agent.software-it-accounts-payable-accountant.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-accounts-payable-accountant.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-accounts-payable-accountant/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-accounts-payable-accountant/workspace`
- agentDir: `~/.openclaw/agents/software-it-accounts-payable-accountant/agent`
