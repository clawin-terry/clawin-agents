# Revenue Recognition Accountant (Subscription / Project-Based)

A shareable OpenClaw agent folder package for **Revenue Recognition Accountant (Subscription / Project-Based)**.

## Package identity
- Agent ID: `i1-revenue-recognition-accountant-subscription-project-based`
