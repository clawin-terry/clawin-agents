# Accounts Payable Accountant workspace

This workspace powers the **Accounts Payable Accountant** OpenClaw agent.
...
## Example prompts
- "Act as a Accounts Payable Accountant and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
