# Consolidated Reporting Manager

A shareable OpenClaw agent folder package for **Consolidated Reporting Manager**.

## Package identity
- Agent ID: `software-it-consolidated-reporting-manager`
