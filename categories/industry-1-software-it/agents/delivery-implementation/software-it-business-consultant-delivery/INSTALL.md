...
```text
~/.openclaw/agents/software-it-business-consultant-delivery
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-business-consultant-delivery`.
2. Open `config/openclaw.agent.software-it-business-consultant-delivery.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-business-consultant-delivery.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-business-consultant-delivery/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-business-consultant-delivery/workspace`
- agentDir: `~/.openclaw/agents/software-it-business-consultant-delivery/agent`
