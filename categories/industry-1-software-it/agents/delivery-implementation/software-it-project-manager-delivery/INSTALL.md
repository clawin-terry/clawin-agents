...
```text
~/.openclaw/agents/software-it-project-manager-delivery
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-project-manager-delivery`.
2. Open `config/openclaw.agent.software-it-project-manager-delivery.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-project-manager-delivery.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-project-manager-delivery/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-project-manager-delivery/workspace`
- agentDir: `~/.openclaw/agents/software-it-project-manager-delivery/agent`
