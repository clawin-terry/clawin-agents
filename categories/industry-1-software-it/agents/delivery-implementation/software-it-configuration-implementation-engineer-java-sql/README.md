# Configuration Implementation Engineer (Java/SQL)

A shareable OpenClaw agent folder package for **Configuration Implementation Engineer (Java/SQL)**.

## Package identity
- Agent ID: `software-it-configuration-implementation-engineer-java-sql`
- Industry: `industry-1-software-it`
- Role family: `delivery-implementation`
