# Install Implementation Consultant
...
```text
~/.openclaw/agents/software-it-implementation-consultant
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-implementation-consultant`.
2. Open `config/openclaw.agent.software-it-implementation-consultant.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-implementation-consultant.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-implementation-consultant/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-implementation-consultant/workspace`
- agentDir: `~/.openclaw/agents/software-it-implementation-consultant/agent`
