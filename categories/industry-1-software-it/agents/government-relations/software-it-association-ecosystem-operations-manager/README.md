# Association and Ecosystem Operations Manager

A shareable OpenClaw agent folder package for **Association and Ecosystem Operations Manager**.

## Package identity
- Agent ID: `software-it-association-ecosystem-operations-manager`
