# Certification and Program Application Manager

A shareable OpenClaw agent folder package for **Certification and Program Application Manager**.

## Package identity
- Agent ID: `software-it-certification-and-program-application-manager`
