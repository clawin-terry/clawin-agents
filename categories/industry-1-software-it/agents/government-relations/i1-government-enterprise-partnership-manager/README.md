# Government and Enterprise Partnership Manager

A shareable OpenClaw agent folder package for **Government and Enterprise Partnership Manager**.

## Package identity
- Agent ID: `i1-government-enterprise-partnership-manager`
