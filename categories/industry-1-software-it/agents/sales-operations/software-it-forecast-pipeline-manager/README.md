# Forecast and Pipeline Manager

A shareable OpenClaw agent folder package for **Forecast and Pipeline Manager**.

## Package identity
- Agent ID: `software-it-forecast-pipeline-manager`
