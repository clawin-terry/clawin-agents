...
```text
~/.openclaw/agents/software-it-sales-data-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-sales-data-analyst`.
2. Open `config/openclaw.agent.software-it-sales-data-analyst.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-sales-data-analyst.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-sales-data-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-sales-data-analyst/workspace`
- agentDir: `~/.openclaw/agents/software-it-sales-data-analyst/agent`
