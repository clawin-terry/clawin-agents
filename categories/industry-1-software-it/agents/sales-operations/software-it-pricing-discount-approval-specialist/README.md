# Pricing and Discount Approval Specialist

A shareable OpenClaw agent folder package for **Pricing and Discount Approval Specialist**.

## Package identity
- Agent ID: `software-it-pricing-discount-approval-specialist`
