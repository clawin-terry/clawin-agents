# Install Database Administrator (SQL)
...
```text
~/.openclaw/agents/software-it-database-administrator-sql
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-database-administrator-sql`.
2. Open `config/openclaw.agent.software-it-database-administrator-sql.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-database-administrator-sql.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-database-administrator-sql/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-database-administrator-sql/workspace`
- agentDir: `~/.openclaw/agents/software-it-database-administrator-sql/agent`
