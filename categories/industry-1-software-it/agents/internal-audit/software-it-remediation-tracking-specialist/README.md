# Remediation Tracking Specialist

A shareable OpenClaw agent folder package for **Remediation Tracking Specialist**.

## Package identity
- Agent ID: `software-it-remediation-tracking-specialist`
