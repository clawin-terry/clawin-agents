# Install CMDB Engineer (Java/Python)
...
```text
~/.openclaw/agents/software-it-cmdb-engineer-java-python
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-cmdb-engineer-java-python`.
2. Open `config/openclaw.agent.software-it-cmdb-engineer-java-python.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-cmdb-engineer-java-python.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-cmdb-engineer-java-python/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-cmdb-engineer-java-python/workspace`
- agentDir: `~/.openclaw/agents/software-it-cmdb-engineer-java-python/agent`
