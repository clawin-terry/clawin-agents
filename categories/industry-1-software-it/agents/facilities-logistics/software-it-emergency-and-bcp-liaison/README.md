# Emergency and BCP Liaison

A shareable OpenClaw agent folder package for **Emergency and BCP Liaison**.

## Package identity
- Agent ID: `software-it-emergency-and-bcp-liaison`
- Industry: `industry-1-software-it`
- Role family: `facilities-logistics`
