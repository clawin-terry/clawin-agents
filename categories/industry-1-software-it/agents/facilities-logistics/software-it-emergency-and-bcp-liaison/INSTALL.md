# Install Emergency and BCP Liaison
...
```text
~/.openclaw/agents/software-it-emergency-and-bcp-liaison
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-emergency-and-bcp-liaison`.
2. Open `config/openclaw.agent.software-it-emergency-and-bcp-liaison.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-emergency-and-bcp-liaison.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-emergency-and-bcp-liaison/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-emergency-and-bcp-liaison/workspace`
- agentDir: `~/.openclaw/agents/software-it-emergency-and-bcp-liaison/agent`
