...
```text
~/.openclaw/agents/software-it-security-supervisor
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-security-supervisor`.
2. Open `config/openclaw.agent.software-it-security-supervisor.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-security-supervisor.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-security-supervisor/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-security-supervisor/workspace`
- agentDir: `~/.openclaw/agents/software-it-security-supervisor/agent`
