# A/B Testing Operations Manager

A shareable OpenClaw agent folder package for **A/B Testing Operations Manager**.

## Package identity
- Agent ID: `software-it-ab-testing-operations-manager`
