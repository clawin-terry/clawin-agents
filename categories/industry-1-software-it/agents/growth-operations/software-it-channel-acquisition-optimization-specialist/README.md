# Channel Acquisition Optimization Specialist

A shareable OpenClaw agent folder package for **Channel Acquisition Optimization Specialist**.

## Package identity
- Agent ID: `software-it-channel-acquisition-optimization-specialist`
- Industry: `industry-1-software-it`
- Role family: `growth-operations`
