...
This workspace powers the **Business Architect** OpenClaw agent.
...
## Example prompts
- "Act as a Business Architect and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
