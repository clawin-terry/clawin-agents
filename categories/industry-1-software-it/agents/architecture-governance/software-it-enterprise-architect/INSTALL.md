...
```text
~/.openclaw/agents/software-it-enterprise-architect
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-enterprise-architect`.
2. Open `config/openclaw.agent.software-it-enterprise-architect.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-enterprise-architect.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-enterprise-architect/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-enterprise-architect/workspace`
- agentDir: `~/.openclaw/agents/software-it-enterprise-architect/agent`
