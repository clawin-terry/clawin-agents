# Project Management Training Instructor

A shareable OpenClaw agent folder package for **Project Management Training Instructor**.

## Package identity
- Agent ID: `software-it-project-management-training-instructor`
