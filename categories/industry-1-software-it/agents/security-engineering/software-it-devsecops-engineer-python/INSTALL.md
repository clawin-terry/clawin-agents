# Install DevSecOps Engineer (Python)
...
```text
~/.openclaw/agents/software-it-devsecops-engineer-python
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-devsecops-engineer-python`.
2. Open `config/openclaw.agent.software-it-devsecops-engineer-python.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-devsecops-engineer-python.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-devsecops-engineer-python/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-devsecops-engineer-python/workspace`
- agentDir: `~/.openclaw/agents/software-it-devsecops-engineer-python/agent`
