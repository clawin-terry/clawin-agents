# Due Diligence Lead (Finance / Legal / Business)

A shareable OpenClaw agent folder package for **Due Diligence Lead (Finance / Legal / Business)**.

## Package identity
- Agent ID: `software-it-due-diligence-lead-finance-legal-business`
- Industry: `industry-1-software-it`
- Role family: `investment-ma`
