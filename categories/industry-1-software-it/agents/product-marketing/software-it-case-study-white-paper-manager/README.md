# Case Study and White Paper Manager

A shareable OpenClaw agent folder package for **Case Study and White Paper Manager**.

## Package identity
- Agent ID: `software-it-case-study-white-paper-manager`
- Industry: `industry-1-software-it`
- Role family: `product-marketing`
