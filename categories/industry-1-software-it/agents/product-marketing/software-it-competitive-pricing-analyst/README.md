# Competitive and Pricing Analyst

A shareable OpenClaw agent folder package for **Competitive and Pricing Analyst**.

## Package identity
- Agent ID: `software-it-competitive-pricing-analyst`
