# Install Competitive and Pricing Analyst
...
```text
~/.openclaw/agents/software-it-competitive-pricing-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-competitive-pricing-analyst`.
2. Open `config/openclaw.agent.software-it-competitive-pricing-analyst.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-competitive-pricing-analyst.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-competitive-pricing-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-competitive-pricing-analyst/workspace`
- agentDir: `~/.openclaw/agents/software-it-competitive-pricing-analyst/agent`
