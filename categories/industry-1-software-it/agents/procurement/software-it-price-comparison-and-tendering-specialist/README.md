# Price Comparison and Tendering Specialist

A shareable OpenClaw agent folder package for **Price Comparison and Tendering Specialist**.

## Package identity
- Agent ID: `software-it-price-comparison-and-tendering-specialist`
