# Cloud Operations Engineer (Python/Shell)

A shareable OpenClaw agent folder package for **Cloud Operations Engineer (Python/Shell)**.

## Package identity
- Agent ID: `software-it-cloud-operations-engineer-python-shell`
- Industry: `industry-1-software-it`
- Role family: `infrastructure-operations`
