...
```text
~/.openclaw/agents/software-it-cloud-operations-engineer-python-shell
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-cloud-operations-engineer-python-shell`.
...
```text
~/.openclaw/agents/software-it-cloud-operations-engineer-python-shell/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-cloud-operations-engineer-python-shell/workspace`
- agentDir: `~/.openclaw/agents/software-it-cloud-operations-engineer-python-shell/agent`
