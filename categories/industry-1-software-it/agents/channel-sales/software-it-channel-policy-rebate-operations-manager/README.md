# Channel Policy and Rebate Operations Manager

A shareable OpenClaw agent folder package for **Channel Policy and Rebate Operations Manager**.

## Package identity
- Agent ID: `software-it-channel-policy-rebate-operations-manager`
- Industry: `industry-1-software-it`
- Role family: `channel-sales`
