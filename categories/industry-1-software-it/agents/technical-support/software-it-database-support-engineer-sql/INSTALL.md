# Install Database Support Engineer (SQL)
...
```text
~/.openclaw/agents/software-it-database-support-engineer-sql
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/software-it-database-support-engineer-sql`.
2. Open `config/openclaw.agent.software-it-database-support-engineer-sql.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.software-it-database-support-engineer-sql.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/software-it-database-support-engineer-sql/workspace/skills
```
...
- workspace: `~/.openclaw/agents/software-it-database-support-engineer-sql/workspace`
- agentDir: `~/.openclaw/agents/software-it-database-support-engineer-sql/agent`
