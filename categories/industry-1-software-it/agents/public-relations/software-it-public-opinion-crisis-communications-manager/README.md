# Public Opinion and Crisis Communications Manager

A shareable OpenClaw agent folder package for **Public Opinion and Crisis Communications Manager**.

## Package identity
- Agent ID: `software-it-public-opinion-crisis-communications-manager`
- Industry: `industry-1-software-it`
- Role family: `public-relations`
