# Executive Spokesperson Support Manager

A shareable OpenClaw agent folder package for **Executive Spokesperson Support Manager**.

## Package identity
- Agent ID: `software-it-executive-spokesperson-support-manager`
