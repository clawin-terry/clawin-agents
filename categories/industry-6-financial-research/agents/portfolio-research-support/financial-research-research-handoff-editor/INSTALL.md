# Install Research Handoff Editor
...
```text
~/.openclaw/agents/financial-research-research-handoff-editor
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-research-handoff-editor`.
...
```text
~/.openclaw/agents/financial-research-research-handoff-editor/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-research-handoff-editor/workspace`
- agentDir: `~/.openclaw/agents/financial-research-research-handoff-editor/agent`
