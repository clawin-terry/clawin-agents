...
```text
~/.openclaw/agents/financial-research-watchlist-curator
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-watchlist-curator`.
...
```text
~/.openclaw/agents/financial-research-watchlist-curator/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-watchlist-curator/workspace`
- agentDir: `~/.openclaw/agents/financial-research-watchlist-curator/agent`
