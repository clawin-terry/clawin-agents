# Watchlist Curator workspace

This workspace powers the **Watchlist Curator** OpenClaw agent.
...
## Example prompts
- "Act as a Watchlist Curator and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
