...
```text
~/.openclaw/agents/financial-research-diligence-tracker
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-diligence-tracker`.
...
```text
~/.openclaw/agents/financial-research-diligence-tracker/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-diligence-tracker/workspace`
- agentDir: `~/.openclaw/agents/financial-research-diligence-tracker/agent`
