# Diligence Tracker workspace

This workspace powers the **Diligence Tracker** OpenClaw agent.
...
## Example prompts
- "Act as a Diligence Tracker and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
