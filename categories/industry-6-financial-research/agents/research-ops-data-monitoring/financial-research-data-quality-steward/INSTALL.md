...
```text
~/.openclaw/agents/financial-research-data-quality-steward
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-data-quality-steward`.
...
```text
~/.openclaw/agents/financial-research-data-quality-steward/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-data-quality-steward/workspace`
- agentDir: `~/.openclaw/agents/financial-research-data-quality-steward/agent`
