# Install Alternative Data Signal Analyst
...
```text
~/.openclaw/agents/financial-research-alt-data-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-alt-data-analyst`.
...
```text
~/.openclaw/agents/financial-research-alt-data-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-alt-data-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-alt-data-analyst/agent`
