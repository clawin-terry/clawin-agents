# Install Memo Standardization Analyst
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-memo-editor-analyst`.
...
```text
~/.openclaw/agents/financial-research-memo-editor-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-memo-editor-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-memo-editor-analyst/agent`
