...
```text
~/.openclaw/agents/financial-research-evidence-gap-tracker
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-evidence-gap-tracker`.
...
```text
~/.openclaw/agents/financial-research-evidence-gap-tracker/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-evidence-gap-tracker/workspace`
- agentDir: `~/.openclaw/agents/financial-research-evidence-gap-tracker/agent`
