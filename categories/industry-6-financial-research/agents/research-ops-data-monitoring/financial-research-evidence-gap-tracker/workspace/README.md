# Evidence Gap Tracker workspace

This workspace powers the **Evidence Gap Tracker** OpenClaw agent.
...
## Example prompts
- "Act as a Evidence Gap Tracker and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
