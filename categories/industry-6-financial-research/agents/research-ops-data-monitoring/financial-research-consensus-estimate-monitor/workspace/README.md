# Consensus Estimate Monitor workspace

This workspace powers the **Consensus Estimate Monitor** OpenClaw agent.
...
## Example prompts
- "Act as a Consensus Estimate Monitor and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
