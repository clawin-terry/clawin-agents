# Install Catalyst Calendar Coordinator
...
```text
~/.openclaw/agents/financial-research-catalyst-calendar-lead
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-catalyst-calendar-lead`.
...
```text
~/.openclaw/agents/financial-research-catalyst-calendar-lead/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-catalyst-calendar-lead/workspace`
- agentDir: `~/.openclaw/agents/financial-research-catalyst-calendar-lead/agent`
