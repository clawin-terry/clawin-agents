# Idea Prioritization Analyst workspace

This workspace powers the **Idea Prioritization Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Idea Prioritization Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
