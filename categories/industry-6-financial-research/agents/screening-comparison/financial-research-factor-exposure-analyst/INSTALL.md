# Install Factor Exposure Analyst
...
```text
~/.openclaw/agents/financial-research-factor-exposure-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-factor-exposure-analyst`.
2. Open `config/openclaw.agent.financial-research-factor-exposure-analyst.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.financial-research-factor-exposure-analyst.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/financial-research-factor-exposure-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-factor-exposure-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-factor-exposure-analyst/agent`
