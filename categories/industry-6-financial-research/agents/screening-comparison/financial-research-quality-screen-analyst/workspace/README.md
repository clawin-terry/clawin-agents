# Quality Screen Analyst workspace

This workspace powers the **Quality Screen Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Quality Screen Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
