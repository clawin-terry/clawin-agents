# Install Quality Screen Analyst
...
```text
~/.openclaw/agents/financial-research-quality-screen-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-quality-screen-analyst`.
...
```text
~/.openclaw/agents/financial-research-quality-screen-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-quality-screen-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-quality-screen-analyst/agent`
