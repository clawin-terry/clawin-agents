# Screener Strategy Analyst workspace

This workspace powers the **Screener Strategy Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Screener Strategy Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
