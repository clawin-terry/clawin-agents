# Market Map Analyst workspace

This workspace powers the **Market Map Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Market Map Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
