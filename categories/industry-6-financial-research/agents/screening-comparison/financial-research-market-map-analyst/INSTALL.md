...
```text
~/.openclaw/agents/financial-research-market-map-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-market-map-analyst`.
...
```text
~/.openclaw/agents/financial-research-market-map-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-market-map-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-market-map-analyst/agent`
