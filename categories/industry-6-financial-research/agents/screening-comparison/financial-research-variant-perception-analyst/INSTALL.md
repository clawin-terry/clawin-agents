# Install Variant Perception Analyst
...
```text
~/.openclaw/agents/financial-research-variant-perception-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-variant-perception-analyst`.
...
```text
~/.openclaw/agents/financial-research-variant-perception-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-variant-perception-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-variant-perception-analyst/agent`
