# Install Relative Value Analyst
...
```text
~/.openclaw/agents/financial-research-relative-value-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-relative-value-analyst`.
...
```text
~/.openclaw/agents/financial-research-relative-value-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-relative-value-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-relative-value-analyst/agent`
