# Guidance Change Analyst workspace

This workspace powers the **Guidance Change Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Guidance Change Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
