# Install Estimate Revision Analyst
...
```text
~/.openclaw/agents/financial-research-estimate-revision-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-estimate-revision-analyst`.
...
```text
~/.openclaw/agents/financial-research-estimate-revision-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-estimate-revision-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-estimate-revision-analyst/agent`
