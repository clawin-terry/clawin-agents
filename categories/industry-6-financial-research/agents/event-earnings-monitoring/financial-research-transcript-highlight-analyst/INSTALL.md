# Install Transcript Highlight Analyst
...
```text
~/.openclaw/agents/financial-research-transcript-highlight-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-transcript-highlight-analyst`.
...
```text
~/.openclaw/agents/financial-research-transcript-highlight-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-transcript-highlight-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-transcript-highlight-analyst/agent`
