# Transcript Highlight Analyst workspace

This workspace powers the **Transcript Highlight Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Transcript Highlight Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
