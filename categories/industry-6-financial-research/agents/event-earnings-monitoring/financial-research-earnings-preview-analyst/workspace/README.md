# Earnings Preview Analyst workspace

This workspace powers the **Earnings Preview Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Earnings Preview Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
