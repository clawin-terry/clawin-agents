# Event Calendar Analyst workspace

This workspace powers the **Event Calendar Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Event Calendar Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
