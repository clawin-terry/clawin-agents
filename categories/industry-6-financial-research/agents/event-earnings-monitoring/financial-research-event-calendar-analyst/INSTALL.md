# Install Event Calendar Analyst
...
```text
~/.openclaw/agents/financial-research-event-calendar-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-event-calendar-analyst`.
...
```text
~/.openclaw/agents/financial-research-event-calendar-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-event-calendar-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-event-calendar-analyst/agent`
