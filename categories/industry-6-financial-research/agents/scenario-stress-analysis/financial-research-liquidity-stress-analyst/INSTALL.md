# Install Liquidity & Balance Sheet Stress Analyst
...
```text
~/.openclaw/agents/financial-research-liquidity-stress-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-liquidity-stress-analyst`.
...
```text
~/.openclaw/agents/financial-research-liquidity-stress-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-liquidity-stress-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-liquidity-stress-analyst/agent`
