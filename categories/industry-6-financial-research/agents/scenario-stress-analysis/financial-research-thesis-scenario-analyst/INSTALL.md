# Install Thesis Scenario Analyst
...
```text
~/.openclaw/agents/financial-research-thesis-scenario-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-thesis-scenario-analyst`.
...
```text
~/.openclaw/agents/financial-research-thesis-scenario-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-thesis-scenario-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-thesis-scenario-analyst/agent`
