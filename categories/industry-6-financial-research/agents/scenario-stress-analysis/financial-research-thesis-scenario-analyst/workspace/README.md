# Thesis Scenario Analyst workspace

This workspace powers the **Thesis Scenario Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Thesis Scenario Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
