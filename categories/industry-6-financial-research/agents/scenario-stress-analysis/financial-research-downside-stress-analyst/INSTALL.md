# Install Downside Stress Analyst
...
```text
~/.openclaw/agents/financial-research-downside-stress-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-downside-stress-analyst`.
...
```text
~/.openclaw/agents/financial-research-downside-stress-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-downside-stress-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-downside-stress-analyst/agent`
