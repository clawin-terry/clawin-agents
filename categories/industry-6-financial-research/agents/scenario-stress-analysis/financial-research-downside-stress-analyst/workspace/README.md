# Downside Stress Analyst workspace

This workspace powers the **Downside Stress Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Downside Stress Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
