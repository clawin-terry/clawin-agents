# Install Sensitivity Matrix Analyst
...
```text
~/.openclaw/agents/financial-research-sensitivity-matrix-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-sensitivity-matrix-analyst`.
...
```text
~/.openclaw/agents/financial-research-sensitivity-matrix-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-sensitivity-matrix-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-sensitivity-matrix-analyst/agent`
