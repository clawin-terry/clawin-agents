# Catalyst Path Analyst workspace

This workspace powers the **Catalyst Path Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Catalyst Path Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
