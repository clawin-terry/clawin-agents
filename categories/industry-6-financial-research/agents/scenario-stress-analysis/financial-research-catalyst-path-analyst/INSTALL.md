...
```text
~/.openclaw/agents/financial-research-catalyst-path-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-catalyst-path-analyst`.
...
```text
~/.openclaw/agents/financial-research-catalyst-path-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-catalyst-path-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-catalyst-path-analyst/agent`
