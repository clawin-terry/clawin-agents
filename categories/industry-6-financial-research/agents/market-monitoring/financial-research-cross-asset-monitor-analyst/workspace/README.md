# Cross-Asset Signal Monitor Analyst workspace

This workspace powers the **Cross-Asset Signal Monitor Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Cross-Asset Signal Monitor Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
