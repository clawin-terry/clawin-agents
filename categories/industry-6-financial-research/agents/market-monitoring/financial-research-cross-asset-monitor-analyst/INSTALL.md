# Install Cross-Asset Signal Monitor Analyst
...
```text
~/.openclaw/agents/financial-research-cross-asset-monitor-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-cross-asset-monitor-analyst`.
...
```text
~/.openclaw/agents/financial-research-cross-asset-monitor-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-cross-asset-monitor-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-cross-asset-monitor-analyst/agent`
