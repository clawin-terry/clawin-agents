# Install Policy & Regulatory Monitor Analyst
...
```text
~/.openclaw/agents/financial-research-policy-monitor-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-policy-monitor-analyst`.
...
```text
~/.openclaw/agents/financial-research-policy-monitor-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-policy-monitor-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-policy-monitor-analyst/agent`
