# News Catalyst Monitor Analyst workspace

This workspace powers the **News Catalyst Monitor Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a News Catalyst Monitor Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
