# Install Sentiment & Positioning Monitor Analyst
...
```text
~/.openclaw/agents/financial-research-sentiment-monitor-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-sentiment-monitor-analyst`.
...
```text
~/.openclaw/agents/financial-research-sentiment-monitor-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-sentiment-monitor-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-sentiment-monitor-analyst/agent`
