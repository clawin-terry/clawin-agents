# Macro Market Monitor Analyst workspace

This workspace powers the **Macro Market Monitor Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Macro Market Monitor Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
