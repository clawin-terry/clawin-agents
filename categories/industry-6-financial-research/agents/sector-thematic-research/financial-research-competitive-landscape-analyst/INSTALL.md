# Install Competitive Landscape Analyst
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-competitive-landscape-analyst`.
...
```text
~/.openclaw/agents/financial-research-competitive-landscape-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-competitive-landscape-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-competitive-landscape-analyst/agent`
