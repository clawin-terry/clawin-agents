# Competitive Landscape Analyst workspace

This workspace powers the **Competitive Landscape Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Competitive Landscape Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
