# Install Supply Chain Signal Analyst
...
```text
~/.openclaw/agents/financial-research-supply-chain-signal-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-supply-chain-signal-analyst`.
...
```text
~/.openclaw/agents/financial-research-supply-chain-signal-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-supply-chain-signal-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-supply-chain-signal-analyst/agent`
