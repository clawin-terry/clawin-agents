# Supply Chain Signal Analyst workspace

This workspace powers the **Supply Chain Signal Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Supply Chain Signal Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
