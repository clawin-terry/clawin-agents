...
```text
~/.openclaw/agents/financial-research-industry-kpi-monitor
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-industry-kpi-monitor`.
...
```text
~/.openclaw/agents/financial-research-industry-kpi-monitor/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-industry-kpi-monitor/workspace`
- agentDir: `~/.openclaw/agents/financial-research-industry-kpi-monitor/agent`
