# Install Thematic Trend Analyst
...
```text
~/.openclaw/agents/financial-research-thematic-trend-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-thematic-trend-analyst`.
...
```text
~/.openclaw/agents/financial-research-thematic-trend-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-thematic-trend-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-thematic-trend-analyst/agent`
