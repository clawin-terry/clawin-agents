# Install Sector Structure Analyst
...
```text
~/.openclaw/agents/financial-research-sector-structure-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-sector-structure-analyst`.
...
```text
~/.openclaw/agents/financial-research-sector-structure-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-sector-structure-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-sector-structure-analyst/agent`
