# Sector Structure Analyst workspace

This workspace powers the **Sector Structure Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Sector Structure Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
