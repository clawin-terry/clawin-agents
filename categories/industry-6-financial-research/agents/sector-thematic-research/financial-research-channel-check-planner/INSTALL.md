...
```text
~/.openclaw/agents/financial-research-channel-check-planner
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-channel-check-planner`.
...
```text
~/.openclaw/agents/financial-research-channel-check-planner/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-channel-check-planner/workspace`
- agentDir: `~/.openclaw/agents/financial-research-channel-check-planner/agent`
