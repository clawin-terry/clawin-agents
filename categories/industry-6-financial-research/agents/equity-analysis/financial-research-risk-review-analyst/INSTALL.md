...
```text
~/.openclaw/agents/financial-research-risk-review-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-risk-review-analyst`.
2. Open `config/openclaw.agent.financial-research-risk-review-analyst.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.financial-research-risk-review-analyst.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/financial-research-risk-review-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-risk-review-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-risk-review-analyst/agent`
