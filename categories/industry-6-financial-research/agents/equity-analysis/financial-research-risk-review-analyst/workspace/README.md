# Risk Review Analyst workspace

This workspace powers the **Risk Review Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Risk Review Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
