# Financial Statement Analyst workspace

This workspace powers the **Financial Statement Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Financial Statement Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
