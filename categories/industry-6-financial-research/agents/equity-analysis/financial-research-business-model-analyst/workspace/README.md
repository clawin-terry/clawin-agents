# Business Model Analyst workspace

This workspace powers the **Business Model Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Business Model Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
