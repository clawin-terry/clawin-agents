# Install Business Model Analyst
...
```text
~/.openclaw/agents/financial-research-business-model-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-business-model-analyst`.
...
```text
~/.openclaw/agents/financial-research-business-model-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-business-model-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-business-model-analyst/agent`
