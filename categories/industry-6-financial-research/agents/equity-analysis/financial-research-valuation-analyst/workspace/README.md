# Valuation Analyst workspace

This workspace powers the **Valuation Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Valuation Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
