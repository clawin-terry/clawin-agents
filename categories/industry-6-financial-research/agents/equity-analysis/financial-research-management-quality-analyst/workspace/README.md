# Management Quality Analyst workspace

This workspace powers the **Management Quality Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Management Quality Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
