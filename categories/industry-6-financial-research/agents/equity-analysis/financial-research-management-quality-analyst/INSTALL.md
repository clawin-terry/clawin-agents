# Install Management Quality Analyst
...
```text
~/.openclaw/agents/financial-research-management-quality-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-management-quality-analyst`.
...
```text
~/.openclaw/agents/financial-research-management-quality-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-management-quality-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-management-quality-analyst/agent`
