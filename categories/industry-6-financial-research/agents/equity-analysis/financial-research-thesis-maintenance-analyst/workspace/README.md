# Thesis Maintenance Analyst workspace

This workspace powers the **Thesis Maintenance Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Thesis Maintenance Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
