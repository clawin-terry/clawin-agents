# Install Thesis Maintenance Analyst
...
```text
~/.openclaw/agents/financial-research-thesis-maintenance-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-thesis-maintenance-analyst`.
...
```text
~/.openclaw/agents/financial-research-thesis-maintenance-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-thesis-maintenance-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-thesis-maintenance-analyst/agent`
