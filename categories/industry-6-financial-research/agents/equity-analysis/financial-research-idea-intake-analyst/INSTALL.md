...
```text
~/.openclaw/agents/financial-research-idea-intake-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-idea-intake-analyst`.
2. Open `config/openclaw.agent.financial-research-idea-intake-analyst.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.financial-research-idea-intake-analyst.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/financial-research-idea-intake-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-idea-intake-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-idea-intake-analyst/agent`
