# Install Capital Allocation Analyst
...
```text
~/.openclaw/agents/financial-research-capital-allocation-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/financial-research-capital-allocation-analyst`.
...
```text
~/.openclaw/agents/financial-research-capital-allocation-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/financial-research-capital-allocation-analyst/workspace`
- agentDir: `~/.openclaw/agents/financial-research-capital-allocation-analyst/agent`
