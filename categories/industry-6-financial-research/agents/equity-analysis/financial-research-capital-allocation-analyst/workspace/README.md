# Capital Allocation Analyst workspace

This workspace powers the **Capital Allocation Analyst** OpenClaw agent.
...
## Example prompts
- "Act as a Capital Allocation Analyst and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
