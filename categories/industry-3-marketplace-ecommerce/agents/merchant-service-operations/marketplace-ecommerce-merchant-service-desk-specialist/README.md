# Merchant Service Desk Specialist

A shareable OpenClaw agent folder package for **Merchant Service Desk Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-service-desk-specialist`
