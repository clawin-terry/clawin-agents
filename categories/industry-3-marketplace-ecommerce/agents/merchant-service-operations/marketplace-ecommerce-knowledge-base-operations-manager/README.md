# Knowledge Base Operations Manager

A shareable OpenClaw agent folder package for **Knowledge Base Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-knowledge-base-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-service-operations`
