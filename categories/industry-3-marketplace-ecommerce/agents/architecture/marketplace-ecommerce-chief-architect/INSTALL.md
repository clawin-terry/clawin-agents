...
```text
~/.openclaw/agents/marketplace-ecommerce-chief-architect
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-chief-architect`.
2. Open `config/openclaw.agent.marketplace-ecommerce-chief-architect.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-chief-architect.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-chief-architect/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-chief-architect/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-chief-architect/agent`
