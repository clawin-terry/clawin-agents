...
```text
~/.openclaw/agents/marketplace-ecommerce-domain-architect
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-domain-architect`.
2. Open `config/openclaw.agent.marketplace-ecommerce-domain-architect.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-domain-architect.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-domain-architect/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-domain-architect/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-domain-architect/agent`
