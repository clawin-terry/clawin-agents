# New User Onboarding Operations Manager

A shareable OpenClaw agent folder package for **New User Onboarding Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-new-user-onboarding-operations-manager`
