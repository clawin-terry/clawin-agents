# Push and User Engagement Operations Manager

A shareable OpenClaw agent folder package for **Push and User Engagement Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-push-and-user-engagement-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `user-lifecycle-operations`
