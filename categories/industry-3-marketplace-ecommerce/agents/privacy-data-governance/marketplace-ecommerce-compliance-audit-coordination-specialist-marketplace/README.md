# Compliance Audit Coordination Specialist (Marketplace)

A shareable OpenClaw agent folder package for **Compliance Audit Coordination Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-compliance-audit-coordination-specialist-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `privacy-data-governance`
