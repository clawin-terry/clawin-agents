# Supply-Side Incentive Strategy Manager

A shareable OpenClaw agent folder package for **Supply-Side Incentive Strategy Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-supply-side-incentive-strategy-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `pricing-profitability-strategy`
