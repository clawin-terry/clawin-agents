# Merchant Training Instructor

A shareable OpenClaw agent folder package for **Merchant Training Instructor**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-training-instructor`
