# Merchant Service Product Operations Manager

A shareable OpenClaw agent folder package for **Merchant Service Product Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-service-product-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-operations`
