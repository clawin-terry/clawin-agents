# Promotional Mechanics Operations Manager

A shareable OpenClaw agent folder package for **Promotional Mechanics Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-promotional-mechanics-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `campaign-operations`
