# Campaign Retrospective Manager

A shareable OpenClaw agent folder package for **Campaign Retrospective Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-campaign-retrospective-manager`
