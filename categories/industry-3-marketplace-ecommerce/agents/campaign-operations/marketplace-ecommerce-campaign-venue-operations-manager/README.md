# Campaign Venue Operations Manager

A shareable OpenClaw agent folder package for **Campaign Venue Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-campaign-venue-operations-manager`
