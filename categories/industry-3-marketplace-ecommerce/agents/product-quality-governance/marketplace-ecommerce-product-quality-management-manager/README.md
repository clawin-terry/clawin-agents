# Product Quality Management Manager

A shareable OpenClaw agent folder package for **Product Quality Management Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-product-quality-management-manager`
