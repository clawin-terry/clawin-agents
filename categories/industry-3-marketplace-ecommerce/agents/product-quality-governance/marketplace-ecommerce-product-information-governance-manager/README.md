# Product Information Governance Manager

A shareable OpenClaw agent folder package for **Product Information Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-product-information-governance-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `product-quality-governance`
