# Performance Manager (Marketplace)

A shareable OpenClaw agent folder package for **Performance Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-performance-manager-marketplace`
