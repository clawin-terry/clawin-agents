# Phone Customer Service Specialist

A shareable OpenClaw agent folder package for **Phone Customer Service Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-phone-customer-service-specialist`
