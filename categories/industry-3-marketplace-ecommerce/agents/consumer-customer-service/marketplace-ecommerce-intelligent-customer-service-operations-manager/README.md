# Intelligent Customer Service Operations Manager

A shareable OpenClaw agent folder package for **Intelligent Customer Service Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-intelligent-customer-service-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `consumer-customer-service`
