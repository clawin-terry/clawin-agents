...
A shareable OpenClaw agent folder package for **Customer Service Quality and Training Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-customer-service-quality-and-training-manager`
