# Live Penalty and Appeals Coordination Manager

A shareable OpenClaw agent folder package for **Live Penalty and Appeals Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-penalty-and-appeals-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `live-risk-and-compliance-operations`
