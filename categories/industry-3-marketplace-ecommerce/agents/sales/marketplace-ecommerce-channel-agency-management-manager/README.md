# Channel Agency Management Manager

A shareable OpenClaw agent folder package for **Channel Agency Management Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-channel-agency-management-manager`
