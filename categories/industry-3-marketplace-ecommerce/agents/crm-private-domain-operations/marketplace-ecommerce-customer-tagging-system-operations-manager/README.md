# Customer Tagging System Operations Manager

A shareable OpenClaw agent folder package for **Customer Tagging System Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-customer-tagging-system-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `crm-private-domain-operations`
