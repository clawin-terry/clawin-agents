...
A shareable OpenClaw agent folder package for **Marketing Automation Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-marketing-automation-operations-manager`
