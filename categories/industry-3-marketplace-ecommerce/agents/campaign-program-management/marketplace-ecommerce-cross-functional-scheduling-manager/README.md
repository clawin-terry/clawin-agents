# Cross-Functional Scheduling Manager

A shareable OpenClaw agent folder package for **Cross-Functional Scheduling Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-cross-functional-scheduling-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `campaign-program-management`
