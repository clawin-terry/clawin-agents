# Supply-Side Mobilization Manager

A shareable OpenClaw agent folder package for **Supply-Side Mobilization Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-supply-side-mobilization-manager`
