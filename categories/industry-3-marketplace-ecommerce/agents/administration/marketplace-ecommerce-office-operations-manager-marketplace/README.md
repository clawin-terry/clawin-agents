# Office Operations Manager (Marketplace)

A shareable OpenClaw agent folder package for **Office Operations Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-office-operations-manager-marketplace`
