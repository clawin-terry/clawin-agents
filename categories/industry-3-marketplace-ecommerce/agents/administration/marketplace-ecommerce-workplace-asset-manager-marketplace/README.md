# Workplace Asset Manager (Marketplace)

A shareable OpenClaw agent folder package for **Workplace Asset Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-workplace-asset-manager-marketplace`
