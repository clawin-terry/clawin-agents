# Brand Authorization Review Specialist

A shareable OpenClaw agent folder package for **Brand Authorization Review Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-brand-authorization-review-specialist`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `brand-partnership-authorization`
