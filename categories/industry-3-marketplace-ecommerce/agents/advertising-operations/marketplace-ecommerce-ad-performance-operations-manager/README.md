# Ad Performance Operations Manager

A shareable OpenClaw agent folder package for **Ad Performance Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-ad-performance-operations-manager`
