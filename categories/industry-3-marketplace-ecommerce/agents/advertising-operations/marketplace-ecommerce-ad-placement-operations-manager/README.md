# Ad Placement Operations Manager

A shareable OpenClaw agent folder package for **Ad Placement Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-ad-placement-operations-manager`
