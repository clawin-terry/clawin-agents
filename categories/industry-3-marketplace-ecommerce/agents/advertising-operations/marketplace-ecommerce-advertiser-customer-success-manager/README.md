# Advertiser Customer Success Manager

A shareable OpenClaw agent folder package for **Advertiser Customer Success Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-advertiser-customer-success-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `advertising-operations`
