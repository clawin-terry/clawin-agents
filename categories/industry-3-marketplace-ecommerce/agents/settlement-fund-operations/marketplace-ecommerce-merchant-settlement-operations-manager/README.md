# Merchant Settlement Operations Manager

A shareable OpenClaw agent folder package for **Merchant Settlement Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-settlement-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `settlement-fund-operations`
