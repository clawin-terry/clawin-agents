# Anti-Money Laundering Coordination Manager

A shareable OpenClaw agent folder package for **Anti-Money Laundering Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-anti-money-laundering-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `risk-compliance-regulatory-operations`
