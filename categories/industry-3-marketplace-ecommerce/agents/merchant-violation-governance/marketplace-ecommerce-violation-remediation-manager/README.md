# Violation Remediation Manager

A shareable OpenClaw agent folder package for **Violation Remediation Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-violation-remediation-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-violation-governance`
