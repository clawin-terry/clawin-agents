# Penalty Follow-Up Manager

A shareable OpenClaw agent folder package for **Penalty Follow-Up Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-penalty-follow-up-manager`
