# Merchant Customer Service Coordination Manager

A shareable OpenClaw agent folder package for **Merchant Customer Service Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-customer-service-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-fulfillment-coordination`
