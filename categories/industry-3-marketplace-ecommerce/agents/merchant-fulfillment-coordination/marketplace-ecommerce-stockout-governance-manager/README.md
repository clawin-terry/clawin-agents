# Stockout Governance Manager

A shareable OpenClaw agent folder package for **Stockout Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-stockout-governance-manager`
