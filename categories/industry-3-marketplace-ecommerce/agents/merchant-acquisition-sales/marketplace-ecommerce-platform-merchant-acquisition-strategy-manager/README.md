# Platform Merchant Acquisition Strategy Manager

A shareable OpenClaw agent folder package for **Platform Merchant Acquisition Strategy Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-platform-merchant-acquisition-strategy-manager`
