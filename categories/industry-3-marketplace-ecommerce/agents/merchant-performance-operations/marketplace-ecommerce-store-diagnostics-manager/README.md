# Store Diagnostics Manager

A shareable OpenClaw agent folder package for **Store Diagnostics Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-store-diagnostics-manager`
