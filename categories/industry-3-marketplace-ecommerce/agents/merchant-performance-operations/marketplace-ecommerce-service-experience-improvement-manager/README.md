# Service Experience Improvement Manager

A shareable OpenClaw agent folder package for **Service Experience Improvement Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-service-experience-improvement-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-performance-operations`
