# Conversion Improvement Manager

A shareable OpenClaw agent folder package for **Conversion Improvement Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-conversion-improvement-manager`
