# Internal Control Manager (Marketplace)

A shareable OpenClaw agent folder package for **Internal Control Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-internal-control-manager-marketplace`
