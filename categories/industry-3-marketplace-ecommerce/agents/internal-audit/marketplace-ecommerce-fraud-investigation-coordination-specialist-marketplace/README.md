# Fraud Investigation Coordination Specialist (Marketplace)

A shareable OpenClaw agent folder package for **Fraud Investigation Coordination Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-fraud-investigation-coordination-specialist-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `internal-audit`
