# Annual OKR Program Manager (Marketplace)

A shareable OpenClaw agent folder package for **Annual OKR Program Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-annual-okr-program-manager-marketplace`
