# Operating Review Program Manager (Marketplace)

A shareable OpenClaw agent folder package for **Operating Review Program Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-operating-review-program-manager-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `strategy-research`
