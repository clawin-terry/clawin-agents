# Campaign Zone Strategy Manager

A shareable OpenClaw agent folder package for **Campaign Zone Strategy Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-campaign-zone-strategy-manager`
