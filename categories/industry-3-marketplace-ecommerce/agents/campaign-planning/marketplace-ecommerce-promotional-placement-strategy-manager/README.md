# Promotional Placement Strategy Manager

A shareable OpenClaw agent folder package for **Promotional Placement Strategy Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-promotional-placement-strategy-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `campaign-planning`
