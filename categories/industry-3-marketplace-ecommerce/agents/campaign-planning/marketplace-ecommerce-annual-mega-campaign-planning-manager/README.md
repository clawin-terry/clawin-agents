# Annual Mega-Campaign Planning Manager

A shareable OpenClaw agent folder package for **Annual Mega-Campaign Planning Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-annual-mega-campaign-planning-manager`
