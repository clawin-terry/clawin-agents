# Employer Brand Manager (Marketplace)

A shareable OpenClaw agent folder package for **Employer Brand Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-employer-brand-manager-marketplace`
