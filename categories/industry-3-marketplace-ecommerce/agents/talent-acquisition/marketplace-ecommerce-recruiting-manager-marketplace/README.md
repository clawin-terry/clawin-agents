# Recruiting Manager (Marketplace)

A shareable OpenClaw agent folder package for **Recruiting Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-recruiting-manager-marketplace`
