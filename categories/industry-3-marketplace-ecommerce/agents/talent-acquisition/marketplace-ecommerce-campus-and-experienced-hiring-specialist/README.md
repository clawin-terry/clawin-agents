# Campus and Experienced Hiring Specialist

A shareable OpenClaw agent folder package for **Campus and Experienced Hiring Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-campus-and-experienced-hiring-specialist`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `talent-acquisition`
