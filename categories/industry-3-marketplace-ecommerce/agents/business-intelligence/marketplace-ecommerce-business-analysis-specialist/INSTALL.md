...
```text
~/.openclaw/agents/marketplace-ecommerce-business-analysis-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-business-analysis-specialist`.
2. Open `config/openclaw.agent.marketplace-ecommerce-business-analysis-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-business-analysis-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-business-analysis-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-business-analysis-specialist/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-business-analysis-specialist/agent`
