...
```text
~/.openclaw/agents/i3-merchant-risk-operations-coordinator
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i3-merchant-risk-operations-coordinator`.
2. Open `config/openclaw.agent.i3-merchant-risk-operations-coordinator.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i3-merchant-risk-operations-coordinator.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i3-merchant-risk-operations-coordinator/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i3-merchant-risk-operations-coordinator/workspace`
- agentDir: `~/.openclaw/agents/i3-merchant-risk-operations-coordinator/agent`
