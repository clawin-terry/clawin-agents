# Merchant Qualification Compliance Specialist

A shareable OpenClaw agent folder package for **Merchant Qualification Compliance Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-qualification-compliance-specialist`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-onboarding-compliance`
