# Contract and Acceptance Specialist (Marketplace)

A shareable OpenClaw agent folder package for **Contract and Acceptance Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-contract-and-acceptance-specialist-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `procurement`
