# Procurement Manager (Marketplace)

A shareable OpenClaw agent folder package for **Procurement Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-procurement-manager-marketplace`
