# Supplier Performance Manager (Marketplace)

A shareable OpenClaw agent folder package for **Supplier Performance Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-supplier-performance-manager-marketplace`
