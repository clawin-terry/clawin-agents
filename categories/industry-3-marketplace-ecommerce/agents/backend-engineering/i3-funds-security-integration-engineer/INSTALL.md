...
```text
~/.openclaw/agents/i3-funds-security-integration-engineer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i3-funds-security-integration-engineer`.
2. Open `config/openclaw.agent.i3-funds-security-integration-engineer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i3-funds-security-integration-engineer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i3-funds-security-integration-engineer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i3-funds-security-integration-engineer/workspace`
- agentDir: `~/.openclaw/agents/i3-funds-security-integration-engineer/agent`
