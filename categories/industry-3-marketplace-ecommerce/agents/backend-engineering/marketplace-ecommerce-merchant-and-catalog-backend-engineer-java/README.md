# Merchant and Catalog Backend Engineer (Java)

A shareable OpenClaw agent folder package for **Merchant and Catalog Backend Engineer (Java)**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-and-catalog-backend-engineer-java`
