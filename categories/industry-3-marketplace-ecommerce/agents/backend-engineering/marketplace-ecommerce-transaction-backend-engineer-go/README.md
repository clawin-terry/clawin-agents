# Transaction Backend Engineer (Go)

A shareable OpenClaw agent folder package for **Transaction Backend Engineer (Go)**.

## Package identity
- Agent ID: `marketplace-ecommerce-transaction-backend-engineer-go`
