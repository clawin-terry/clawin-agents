# Merchant and Catalog Backend Engineer (Go)

A shareable OpenClaw agent folder package for **Merchant and Catalog Backend Engineer (Go)**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-and-catalog-backend-engineer-go`
