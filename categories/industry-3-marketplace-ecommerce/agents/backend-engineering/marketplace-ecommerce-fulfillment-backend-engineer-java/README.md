# Fulfillment Backend Engineer (Java)

A shareable OpenClaw agent folder package for **Fulfillment Backend Engineer (Java)**.

## Package identity
- Agent ID: `marketplace-ecommerce-fulfillment-backend-engineer-java`
