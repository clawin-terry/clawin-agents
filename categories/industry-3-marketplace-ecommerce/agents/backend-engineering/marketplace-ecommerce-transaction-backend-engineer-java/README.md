# Transaction Backend Engineer (Java)

A shareable OpenClaw agent folder package for **Transaction Backend Engineer (Java)**.

## Package identity
- Agent ID: `marketplace-ecommerce-transaction-backend-engineer-java`
