# Fulfillment Backend Engineer (Go)

A shareable OpenClaw agent folder package for **Fulfillment Backend Engineer (Go)**.

## Package identity
- Agent ID: `marketplace-ecommerce-fulfillment-backend-engineer-go`
