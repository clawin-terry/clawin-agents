# Payments Backend Engineer (Go)

A shareable OpenClaw agent folder package for **Payments Backend Engineer (Go)**.

## Package identity
- Agent ID: `marketplace-ecommerce-payments-backend-engineer-go`
