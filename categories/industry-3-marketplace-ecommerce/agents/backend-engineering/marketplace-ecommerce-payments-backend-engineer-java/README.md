# Payments Backend Engineer (Java)

A shareable OpenClaw agent folder package for **Payments Backend Engineer (Java)**.

## Package identity
- Agent ID: `marketplace-ecommerce-payments-backend-engineer-java`
