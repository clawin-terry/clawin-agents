# Benefits Design Operations Manager

A shareable OpenClaw agent folder package for **Benefits Design Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-benefits-design-operations-manager`
