# Member Campaign Operations Manager

A shareable OpenClaw agent folder package for **Member Campaign Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-member-campaign-operations-manager`
