# Membership Program Operations Manager

A shareable OpenClaw agent folder package for **Membership Program Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-membership-program-operations-manager`
