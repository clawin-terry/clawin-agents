# Cross-Border Compliance Coordination Manager

A shareable OpenClaw agent folder package for **Cross-Border Compliance Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-cross-border-compliance-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `cross-border-fulfillment-operations`
