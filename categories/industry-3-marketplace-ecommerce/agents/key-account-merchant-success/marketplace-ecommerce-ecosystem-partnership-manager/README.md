...
A shareable OpenClaw agent folder package for **Ecosystem Partnership Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-ecosystem-partnership-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `key-account-merchant-success`
