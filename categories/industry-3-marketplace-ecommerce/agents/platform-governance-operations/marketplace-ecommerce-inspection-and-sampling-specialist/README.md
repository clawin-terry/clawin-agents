# Inspection and Sampling Specialist

A shareable OpenClaw agent folder package for **Inspection and Sampling Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-inspection-and-sampling-specialist`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `platform-governance-operations`
