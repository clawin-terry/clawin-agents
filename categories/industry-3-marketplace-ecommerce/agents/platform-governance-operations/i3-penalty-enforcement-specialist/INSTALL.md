...
```text
~/.openclaw/agents/i3-penalty-enforcement-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i3-penalty-enforcement-specialist`.
2. Open `config/openclaw.agent.i3-penalty-enforcement-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i3-penalty-enforcement-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i3-penalty-enforcement-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i3-penalty-enforcement-specialist/workspace`
- agentDir: `~/.openclaw/agents/i3-penalty-enforcement-specialist/agent`
