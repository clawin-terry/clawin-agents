# Exception Order Governance Manager

A shareable OpenClaw agent folder package for **Exception Order Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-exception-order-governance-manager`
