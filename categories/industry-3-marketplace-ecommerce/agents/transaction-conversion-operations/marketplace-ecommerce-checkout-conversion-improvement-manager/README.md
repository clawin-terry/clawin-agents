# Checkout Conversion Improvement Manager

A shareable OpenClaw agent folder package for **Checkout Conversion Improvement Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-checkout-conversion-improvement-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `transaction-conversion-operations`
