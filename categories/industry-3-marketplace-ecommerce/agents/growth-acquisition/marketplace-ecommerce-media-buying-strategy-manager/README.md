# Media Buying Strategy Manager

A shareable OpenClaw agent folder package for **Media Buying Strategy Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-media-buying-strategy-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `growth-acquisition`
