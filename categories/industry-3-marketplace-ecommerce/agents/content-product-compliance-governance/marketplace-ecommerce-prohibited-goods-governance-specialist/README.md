# Prohibited Goods Governance Specialist

A shareable OpenClaw agent folder package for **Prohibited Goods Governance Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-prohibited-goods-governance-specialist`
