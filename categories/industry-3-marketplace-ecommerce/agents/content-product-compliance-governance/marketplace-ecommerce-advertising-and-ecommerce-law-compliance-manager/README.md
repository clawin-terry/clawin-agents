# Advertising and Ecommerce Law Compliance Manager

A shareable OpenClaw agent folder package for **Advertising and Ecommerce Law Compliance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-advertising-and-ecommerce-law-compliance-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `content-product-compliance-governance`
