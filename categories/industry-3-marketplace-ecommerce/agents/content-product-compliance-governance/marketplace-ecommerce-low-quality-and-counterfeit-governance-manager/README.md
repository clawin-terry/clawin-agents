# Low-Quality and Counterfeit Governance Manager

A shareable OpenClaw agent folder package for **Low-Quality and Counterfeit Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-low-quality-and-counterfeit-governance-manager`
