# Revenue and Cost Accountant (Marketplace)

A shareable OpenClaw agent folder package for **Revenue and Cost Accountant (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-revenue-and-cost-accountant-marketplace`
