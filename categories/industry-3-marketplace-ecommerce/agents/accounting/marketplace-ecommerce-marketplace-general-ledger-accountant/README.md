# Marketplace General Ledger Accountant

A shareable OpenClaw agent folder package for **Marketplace General Ledger Accountant**.

## Package identity
- Agent ID: `marketplace-ecommerce-marketplace-general-ledger-accountant`
