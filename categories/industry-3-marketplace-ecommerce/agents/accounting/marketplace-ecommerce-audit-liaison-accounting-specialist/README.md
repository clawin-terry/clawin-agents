# Audit Liaison Accounting Specialist

A shareable OpenClaw agent folder package for **Audit Liaison Accounting Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-audit-liaison-accounting-specialist`
