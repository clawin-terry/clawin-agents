...
```text
~/.openclaw/agents/i3-marketplace-general-ledger-accountant
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i3-marketplace-general-ledger-accountant`.
2. Open `config/openclaw.agent.i3-marketplace-general-ledger-accountant.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i3-marketplace-general-ledger-accountant.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i3-marketplace-general-ledger-accountant/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i3-marketplace-general-ledger-accountant/workspace`
- agentDir: `~/.openclaw/agents/i3-marketplace-general-ledger-accountant/agent`
