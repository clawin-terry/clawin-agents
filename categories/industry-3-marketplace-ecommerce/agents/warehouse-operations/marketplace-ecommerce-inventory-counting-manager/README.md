# Inventory Counting Manager

A shareable OpenClaw agent folder package for **Inventory Counting Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-inventory-counting-manager`
