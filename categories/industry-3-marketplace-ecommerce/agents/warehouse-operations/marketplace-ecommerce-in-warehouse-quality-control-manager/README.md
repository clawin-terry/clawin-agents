# In-Warehouse Quality Control Manager

A shareable OpenClaw agent folder package for **In-Warehouse Quality Control Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-in-warehouse-quality-control-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `warehouse-operations`
