# Inbound and Putaway Operations Manager

A shareable OpenClaw agent folder package for **Inbound and Putaway Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-inbound-putaway-operations-manager`
