# Wave Strategy Operations Manager

A shareable OpenClaw agent folder package for **Wave Strategy Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-wave-strategy-operations-manager`
