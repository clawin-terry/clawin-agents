# Illicit Network Disruption Coordination Manager

A shareable OpenClaw agent folder package for **Illicit Network Disruption Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-illicit-network-disruption-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `transaction-risk-operations`
