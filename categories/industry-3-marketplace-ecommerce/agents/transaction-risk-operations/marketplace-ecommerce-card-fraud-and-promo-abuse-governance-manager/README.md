# Card Fraud and Promo Abuse Governance Manager

A shareable OpenClaw agent folder package for **Card Fraud and Promo Abuse Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-card-fraud-and-promo-abuse-governance-manager`
