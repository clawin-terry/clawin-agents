# Process Governance Manager (Marketplace)

A shareable OpenClaw agent folder package for **Process Governance Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-process-governance-manager-marketplace`
