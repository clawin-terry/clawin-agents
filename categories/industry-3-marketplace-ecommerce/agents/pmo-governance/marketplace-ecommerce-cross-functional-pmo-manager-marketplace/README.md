# Cross-Functional PMO Manager (Marketplace)

A shareable OpenClaw agent folder package for **Cross-Functional PMO Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-cross-functional-pmo-manager-marketplace`
