...
```text
~/.openclaw/agents/marketplace-ecommerce-interaction-designer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-interaction-designer`.
2. Open `config/openclaw.agent.marketplace-ecommerce-interaction-designer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-interaction-designer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-interaction-designer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-interaction-designer/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-interaction-designer/agent`
