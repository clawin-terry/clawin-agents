...
```text
~/.openclaw/agents/marketplace-ecommerce-design-systems-lead
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-design-systems-lead`.
2. Open `config/openclaw.agent.marketplace-ecommerce-design-systems-lead.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-design-systems-lead.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-design-systems-lead/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-design-systems-lead/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-design-systems-lead/agent`
