# Policy Research Manager (Marketplace)

A shareable OpenClaw agent folder package for **Policy Research Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-policy-research-manager-marketplace`
