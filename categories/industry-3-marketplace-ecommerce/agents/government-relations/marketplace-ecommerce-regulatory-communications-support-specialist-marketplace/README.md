# Regulatory Communications Support Specialist (Marketplace)

A shareable OpenClaw agent folder package for **Regulatory Communications Support Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-regulatory-communications-support-specialist-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `government-relations`
