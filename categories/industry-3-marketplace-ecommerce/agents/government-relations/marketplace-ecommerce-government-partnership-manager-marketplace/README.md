# Government Partnership Manager (Marketplace)

A shareable OpenClaw agent folder package for **Government Partnership Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-government-partnership-manager-marketplace`
