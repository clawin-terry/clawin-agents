# Cold-Start Content Operations Manager

A shareable OpenClaw agent folder package for **Cold-Start Content Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-cold-start-content-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `content-distribution-strategy`
