# Content Pool Operations Manager

A shareable OpenClaw agent folder package for **Content Pool Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-content-pool-operations-manager`
