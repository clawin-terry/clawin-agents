# Platform Intervention Operations Manager

A shareable OpenClaw agent folder package for **Platform Intervention Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-platform-intervention-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `aftersales-dispute-arbitration`
