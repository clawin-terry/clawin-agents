# Experience Improvement Project Manager

A shareable OpenClaw agent folder package for **Experience Improvement Project Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-experience-improvement-project-manager`
