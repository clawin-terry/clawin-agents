# Issue Closure Operations Manager

A shareable OpenClaw agent folder package for **Issue Closure Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-issue-closure-operations-manager`
