# Install Voice of Customer Analyst
...
```text
~/.openclaw/agents/marketplace-ecommerce-voc-analyst
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-voc-analyst`.
2. Open `config/openclaw.agent.marketplace-ecommerce-voc-analyst.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-voc-analyst.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-voc-analyst/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-voc-analyst/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-voc-analyst/agent`
