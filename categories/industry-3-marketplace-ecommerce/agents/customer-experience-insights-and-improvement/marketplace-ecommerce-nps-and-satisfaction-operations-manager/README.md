# NPS and Satisfaction Operations Manager

A shareable OpenClaw agent folder package for **NPS and Satisfaction Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-nps-and-satisfaction-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `customer-experience-insights-and-improvement`
