# Rebate and Contract Rules Manager

A shareable OpenClaw agent folder package for **Rebate and Contract Rules Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-rebate-and-contract-rules-manager`
