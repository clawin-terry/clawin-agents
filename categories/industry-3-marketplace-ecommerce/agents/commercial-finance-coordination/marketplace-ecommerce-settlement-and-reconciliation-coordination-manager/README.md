# Settlement and Reconciliation Coordination Manager

A shareable OpenClaw agent folder package for **Settlement and Reconciliation Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-settlement-and-reconciliation-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `commercial-finance-coordination`
