# Risk and Compliance Coordination Manager

A shareable OpenClaw agent folder package for **Risk and Compliance Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-risk-and-compliance-coordination-manager`
