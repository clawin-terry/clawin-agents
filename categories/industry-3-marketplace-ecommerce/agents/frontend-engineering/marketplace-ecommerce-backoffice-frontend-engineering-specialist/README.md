# Backoffice Frontend Engineering Specialist

A shareable OpenClaw agent folder package for **Backoffice Frontend Engineering Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-backoffice-frontend-engineering-specialist`
