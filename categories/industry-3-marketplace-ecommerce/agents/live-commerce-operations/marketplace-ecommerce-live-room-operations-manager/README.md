# Live Room Operations Manager

A shareable OpenClaw agent folder package for **Live Room Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-room-operations-manager`
