# Live Merchandise Assortment Manager

A shareable OpenClaw agent folder package for **Live Merchandise Assortment Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-merchandise-assortment-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `live-commerce-operations`
