# Live Host Operations Manager

A shareable OpenClaw agent folder package for **Live Host Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-host-operations-manager`
