# Content Quality Governance Coordination Manager

A shareable OpenClaw agent folder package for **Content Quality Governance Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-content-quality-governance-coordination-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `content-creator-operations`
