...
```text
~/.openclaw/agents/marketplace-ecommerce-platform-engineer-go
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-platform-engineer-go`.
2. Open `config/openclaw.agent.marketplace-ecommerce-platform-engineer-go.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-platform-engineer-go.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-platform-engineer-go/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-platform-engineer-go/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-platform-engineer-go/agent`
