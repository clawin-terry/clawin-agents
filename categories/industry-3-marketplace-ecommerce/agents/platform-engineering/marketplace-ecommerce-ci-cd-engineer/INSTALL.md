...
```text
~/.openclaw/agents/marketplace-ecommerce-ci-cd-engineer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-ci-cd-engineer`.
2. Open `config/openclaw.agent.marketplace-ecommerce-ci-cd-engineer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-ci-cd-engineer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-ci-cd-engineer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-ci-cd-engineer/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-ci-cd-engineer/agent`
