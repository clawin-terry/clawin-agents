# Budget and Rolling Forecast Manager (Marketplace)

A shareable OpenClaw agent folder package for **Budget and Rolling Forecast Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-budget-and-rolling-forecast-manager-marketplace`
