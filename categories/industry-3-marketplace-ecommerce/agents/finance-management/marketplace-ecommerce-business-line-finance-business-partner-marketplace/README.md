# Business Line Finance Business Partner (Marketplace)

A shareable OpenClaw agent folder package for **Business Line Finance Business Partner (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-business-line-finance-business-partner-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `finance-management`
