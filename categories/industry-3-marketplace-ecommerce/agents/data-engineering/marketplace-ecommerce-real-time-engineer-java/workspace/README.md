# Real-Time Engineer (Java) workspace

This workspace powers the **Real-Time Engineer (Java)** OpenClaw agent.
...
## Example prompts
- "Act as a Real-Time Engineer (Java) and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
