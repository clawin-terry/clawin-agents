...
```text
~/.openclaw/agents/marketplace-ecommerce-data-engineer-scala
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-data-engineer-scala`.
2. Open `config/openclaw.agent.marketplace-ecommerce-data-engineer-scala.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.marketplace-ecommerce-data-engineer-scala.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/marketplace-ecommerce-data-engineer-scala/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-data-engineer-scala/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-data-engineer-scala/agent`
