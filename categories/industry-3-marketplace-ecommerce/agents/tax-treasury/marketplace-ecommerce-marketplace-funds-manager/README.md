# Marketplace Funds Manager

A shareable OpenClaw agent folder package for **Marketplace Funds Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-marketplace-funds-manager`
