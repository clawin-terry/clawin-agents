# Cross-Border Tax Coordination Specialist (Marketplace)

A shareable OpenClaw agent folder package for **Cross-Border Tax Coordination Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-cross-border-tax-coordination-specialist-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `tax-treasury`
