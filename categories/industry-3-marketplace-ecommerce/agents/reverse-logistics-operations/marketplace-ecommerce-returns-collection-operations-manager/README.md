# Returns Collection Operations Manager

A shareable OpenClaw agent folder package for **Returns Collection Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-returns-collection-operations-manager`
