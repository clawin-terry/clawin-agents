# Secondary Sales Operations Manager

A shareable OpenClaw agent folder package for **Secondary Sales Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-secondary-sales-operations-manager`
