# Returned Goods Quality Inspection Manager

A shareable OpenClaw agent folder package for **Returned Goods Quality Inspection Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-returned-goods-quality-inspection-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `reverse-logistics-operations`
