# Live Subsidy and Incentives Manager

A shareable OpenClaw agent folder package for **Live Subsidy and Incentives Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-subsidy-and-incentives-manager`
