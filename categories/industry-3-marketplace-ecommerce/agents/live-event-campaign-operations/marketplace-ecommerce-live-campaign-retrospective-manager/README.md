# Live Campaign Retrospective Manager

A shareable OpenClaw agent folder package for **Live Campaign Retrospective Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-campaign-retrospective-manager`
