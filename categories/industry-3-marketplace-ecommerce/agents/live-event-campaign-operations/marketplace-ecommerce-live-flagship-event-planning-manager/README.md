# Live Flagship Event Planning Manager

A shareable OpenClaw agent folder package for **Live Flagship Event Planning Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-flagship-event-planning-manager`
