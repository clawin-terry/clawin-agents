# Live Slot and Resource Operations Manager

A shareable OpenClaw agent folder package for **Live Slot and Resource Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-slot-and-resource-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `live-event-campaign-operations`
