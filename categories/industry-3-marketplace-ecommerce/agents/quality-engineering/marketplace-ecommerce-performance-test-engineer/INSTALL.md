...
```text
~/.openclaw/agents/marketplace-ecommerce-performance-test-engineer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/marketplace-ecommerce-performance-test-engineer`.
...
```text
~/.openclaw/agents/marketplace-ecommerce-performance-test-engineer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/marketplace-ecommerce-performance-test-engineer/workspace`
- agentDir: `~/.openclaw/agents/marketplace-ecommerce-performance-test-engineer/agent`
