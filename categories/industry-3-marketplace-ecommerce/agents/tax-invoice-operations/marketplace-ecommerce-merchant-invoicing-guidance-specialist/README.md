# Merchant Invoicing Guidance Specialist

A shareable OpenClaw agent folder package for **Merchant Invoicing Guidance Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-invoicing-guidance-specialist`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `tax-invoice-operations`
