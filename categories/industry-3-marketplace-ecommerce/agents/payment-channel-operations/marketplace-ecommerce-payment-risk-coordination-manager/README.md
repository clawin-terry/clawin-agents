# Payment Risk Coordination Manager

A shareable OpenClaw agent folder package for **Payment Risk Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-payment-risk-coordination-manager`
