# Payment Fee Negotiation Support Manager

A shareable OpenClaw agent folder package for **Payment Fee Negotiation Support Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-payment-fee-negotiation-support-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `payment-channel-operations`
