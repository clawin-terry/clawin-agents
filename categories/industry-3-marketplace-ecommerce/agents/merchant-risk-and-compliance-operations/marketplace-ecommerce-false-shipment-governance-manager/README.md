# False Shipment Governance Manager

A shareable OpenClaw agent folder package for **False Shipment Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-false-shipment-governance-manager`
