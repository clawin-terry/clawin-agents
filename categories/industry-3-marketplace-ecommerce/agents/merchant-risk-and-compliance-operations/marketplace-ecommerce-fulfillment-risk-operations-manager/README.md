# Fulfillment Risk Operations Manager

A shareable OpenClaw agent folder package for **Fulfillment Risk Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-fulfillment-risk-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `merchant-risk-and-compliance-operations`
