# Credential Fraud Governance Manager

A shareable OpenClaw agent folder package for **Credential Fraud Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-credential-fraud-governance-manager`
