# Marketplace Dispute Resolution Counsel

A shareable OpenClaw agent folder package for **Marketplace Dispute Resolution Counsel**.

## Package identity
- Agent ID: `marketplace-ecommerce-marketplace-dispute-resolution-counsel`
