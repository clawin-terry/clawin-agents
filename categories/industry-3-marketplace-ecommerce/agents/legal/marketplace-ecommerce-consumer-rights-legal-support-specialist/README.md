# Consumer Rights Legal Support Specialist

A shareable OpenClaw agent folder package for **Consumer Rights Legal Support Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-consumer-rights-legal-support-specialist`
