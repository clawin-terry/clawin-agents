# Merchant Onboarding Contract Counsel

A shareable OpenClaw agent folder package for **Merchant Onboarding Contract Counsel**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-onboarding-contract-counsel`
