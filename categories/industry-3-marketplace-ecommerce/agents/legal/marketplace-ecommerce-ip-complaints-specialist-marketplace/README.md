# IP Complaints Specialist (Marketplace)

A shareable OpenClaw agent folder package for **IP Complaints Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-ip-complaints-specialist-marketplace`
