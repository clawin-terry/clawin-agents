# Chargeback Coordination Manager

A shareable OpenClaw agent folder package for **Chargeback Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-chargeback-coordination-manager`
