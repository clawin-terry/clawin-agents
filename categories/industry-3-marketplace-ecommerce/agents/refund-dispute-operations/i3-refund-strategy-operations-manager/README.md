# Refund Strategy Operations Manager

A shareable OpenClaw agent folder package for **Refund Strategy Operations Manager**.

## Package identity
- Agent ID: `i3-refund-strategy-operations-manager`
