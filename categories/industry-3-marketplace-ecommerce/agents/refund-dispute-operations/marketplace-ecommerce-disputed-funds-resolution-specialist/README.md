# Disputed Funds Resolution Specialist

A shareable OpenClaw agent folder package for **Disputed Funds Resolution Specialist**.

## Package identity
- Agent ID: `marketplace-ecommerce-disputed-funds-resolution-specialist`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `refund-dispute-operations`
