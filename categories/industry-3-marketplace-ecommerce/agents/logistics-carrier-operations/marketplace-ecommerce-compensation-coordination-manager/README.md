# Compensation Coordination Manager

A shareable OpenClaw agent folder package for **Compensation Coordination Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-compensation-coordination-manager`
