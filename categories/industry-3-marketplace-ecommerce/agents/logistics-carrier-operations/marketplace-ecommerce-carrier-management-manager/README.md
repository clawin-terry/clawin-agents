# Carrier Management Manager

A shareable OpenClaw agent folder package for **Carrier Management Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-carrier-management-manager`
