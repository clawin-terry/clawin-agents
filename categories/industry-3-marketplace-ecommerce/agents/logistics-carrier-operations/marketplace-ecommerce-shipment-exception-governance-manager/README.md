# Shipment Exception Governance Manager

A shareable OpenClaw agent folder package for **Shipment Exception Governance Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-shipment-exception-governance-manager`
