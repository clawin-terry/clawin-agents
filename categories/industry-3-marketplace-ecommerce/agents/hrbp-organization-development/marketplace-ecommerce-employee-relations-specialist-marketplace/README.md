# Employee Relations Specialist (Marketplace)

A shareable OpenClaw agent folder package for **Employee Relations Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-employee-relations-specialist-marketplace`
