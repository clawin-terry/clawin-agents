# HR Shared Services Specialist (Marketplace)

A shareable OpenClaw agent folder package for **HR Shared Services Specialist (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-hr-shared-services-specialist-marketplace`
