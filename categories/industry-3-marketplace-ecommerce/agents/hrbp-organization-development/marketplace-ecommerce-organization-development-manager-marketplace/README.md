# Organization Development Manager (Marketplace)

A shareable OpenClaw agent folder package for **Organization Development Manager (Marketplace)**.

## Package identity
- Agent ID: `marketplace-ecommerce-organization-development-manager-marketplace`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `hrbp-organization-development`
