...
A shareable OpenClaw agent folder package for **Category Operations Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-category-operations-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `category-operations`
