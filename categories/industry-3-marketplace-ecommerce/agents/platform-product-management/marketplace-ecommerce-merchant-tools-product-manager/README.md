# Merchant Tools Product Manager

A shareable OpenClaw agent folder package for **Merchant Tools Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-tools-product-manager`
