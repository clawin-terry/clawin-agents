# Category and Product Catalog Product Manager

A shareable OpenClaw agent folder package for **Category and Product Catalog Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-category-and-product-catalog-product-manager`
