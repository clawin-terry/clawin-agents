# Returns and Aftersales Product Manager

A shareable OpenClaw agent folder package for **Returns and Aftersales Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-returns-and-aftersales-product-manager`
