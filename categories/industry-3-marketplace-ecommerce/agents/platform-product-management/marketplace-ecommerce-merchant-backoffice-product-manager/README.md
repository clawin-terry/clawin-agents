# Merchant Backoffice Product Manager

A shareable OpenClaw agent folder package for **Merchant Backoffice Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-backoffice-product-manager`
