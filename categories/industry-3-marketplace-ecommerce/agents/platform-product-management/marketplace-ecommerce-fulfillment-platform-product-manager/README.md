# Fulfillment Platform Product Manager

A shareable OpenClaw agent folder package for **Fulfillment Platform Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-fulfillment-platform-product-manager`
