# Cart and Checkout Product Manager

A shareable OpenClaw agent folder package for **Cart and Checkout Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-cart-and-checkout-product-manager`
