# Live Commerce Product Manager

A shareable OpenClaw agent folder package for **Live Commerce Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-live-commerce-product-manager`
