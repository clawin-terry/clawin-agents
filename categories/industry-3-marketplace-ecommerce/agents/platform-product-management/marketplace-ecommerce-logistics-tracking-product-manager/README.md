# Logistics Tracking Product Manager

A shareable OpenClaw agent folder package for **Logistics Tracking Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-logistics-tracking-product-manager`
