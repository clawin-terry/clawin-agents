# Merchant Acquisition Product Manager

A shareable OpenClaw agent folder package for **Merchant Acquisition Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-merchant-acquisition-product-manager`
