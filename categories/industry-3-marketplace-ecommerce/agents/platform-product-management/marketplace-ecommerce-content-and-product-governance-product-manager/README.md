# Content and Product Governance Product Manager

A shareable OpenClaw agent folder package for **Content and Product Governance Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-content-and-product-governance-product-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `platform-product-management`
