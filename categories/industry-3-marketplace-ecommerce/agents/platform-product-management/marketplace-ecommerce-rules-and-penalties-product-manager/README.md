# Rules and Penalties Product Manager

A shareable OpenClaw agent folder package for **Rules and Penalties Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-rules-and-penalties-product-manager`
