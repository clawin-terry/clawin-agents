# Transaction Flow Product Manager

A shareable OpenClaw agent folder package for **Transaction Flow Product Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-transaction-flow-product-manager`
