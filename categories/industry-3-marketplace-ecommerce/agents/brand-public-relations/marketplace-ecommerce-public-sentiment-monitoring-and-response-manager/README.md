# Public Sentiment Monitoring and Response Manager

A shareable OpenClaw agent folder package for **Public Sentiment Monitoring and Response Manager**.

## Package identity
- Agent ID: `marketplace-ecommerce-public-sentiment-monitoring-and-response-manager`
- Industry: `industry-3-marketplace-ecommerce`
- Role family: `brand-public-relations`
