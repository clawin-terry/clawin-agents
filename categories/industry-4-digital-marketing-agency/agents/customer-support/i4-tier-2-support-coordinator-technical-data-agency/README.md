# Tier 2 Support Coordinator, Technical and Data Liaison (Agency)

A shareable OpenClaw agent folder package for **Tier 2 Support Coordinator, Technical and Data Liaison (Agency)**.

## Package identity
- Agent ID: `i4-tier-2-support-coordinator-technical-data-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `customer-support`
