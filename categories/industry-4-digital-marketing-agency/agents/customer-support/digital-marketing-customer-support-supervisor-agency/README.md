# Customer Support Supervisor (Agency)

A shareable OpenClaw agent folder package for **Customer Support Supervisor (Agency)**.

## Package identity
- Agent ID: `digital-marketing-customer-support-supervisor-agency`
