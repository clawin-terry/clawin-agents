# Knowledge Base Operations Specialist (Agency)

A shareable OpenClaw agent folder package for **Knowledge Base Operations Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-knowledge-base-operations-specialist-agency`
