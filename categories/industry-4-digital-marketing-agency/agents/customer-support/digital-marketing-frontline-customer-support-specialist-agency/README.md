# Frontline Customer Support Specialist (Agency)

A shareable OpenClaw agent folder package for **Frontline Customer Support Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-frontline-customer-support-specialist-agency`
