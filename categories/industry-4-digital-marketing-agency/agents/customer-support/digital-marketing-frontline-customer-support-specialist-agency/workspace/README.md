# Frontline Customer Support Specialist (Agency) workspace

This workspace powers the **Frontline Customer Support Specialist (Agency)** OpenClaw agent.
...
## Example prompts
- "Act as a Frontline Customer Support Specialist (Agency) and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
