# Bilibili Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **Bilibili Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-bilibili-ads-specialist-agency`
