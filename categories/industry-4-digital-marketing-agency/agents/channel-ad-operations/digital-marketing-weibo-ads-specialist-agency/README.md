# Weibo Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **Weibo Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-weibo-ads-specialist-agency`
