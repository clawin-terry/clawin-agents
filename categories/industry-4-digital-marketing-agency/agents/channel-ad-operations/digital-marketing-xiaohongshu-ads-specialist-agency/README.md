# Xiaohongshu Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **Xiaohongshu Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-xiaohongshu-ads-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `channel-ad-operations`
