# Campaign Operations Specialist (Agency)

A shareable OpenClaw agent folder package for **Campaign Operations Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-campaign-operations-specialist-agency`
