# Membership Operations Specialist (Agency)

A shareable OpenClaw agent folder package for **Membership Operations Specialist (Agency)**.

## Package identity
- Agent ID: `i4-membership-operations-specialist-agency`
