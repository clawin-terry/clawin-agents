# Merchandising Operator (Agency)

A shareable OpenClaw agent folder package for **Merchandising Operator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-merchandising-operator-agency`
