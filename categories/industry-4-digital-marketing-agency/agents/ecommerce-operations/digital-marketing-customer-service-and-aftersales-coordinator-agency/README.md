# Customer Service and Aftersales Coordinator (Agency)

A shareable OpenClaw agent folder package for **Customer Service and Aftersales Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-customer-service-and-aftersales-coordinator-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `ecommerce-operations`
