# DSP Campaign Manager (Agency)

A shareable OpenClaw agent folder package for **DSP Campaign Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-dsp-campaign-manager-agency`
