# Frequency and Audience Expansion Specialist (Agency)

A shareable OpenClaw agent folder package for **Frequency and Audience Expansion Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-frequency-and-audience-expansion-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `programmatic-ad-operations`
