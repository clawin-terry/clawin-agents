# ADX and SSP Resource Coordinator (Agency)

A shareable OpenClaw agent folder package for **ADX and SSP Resource Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-adx-ssp-resource-coordinator-agency`
