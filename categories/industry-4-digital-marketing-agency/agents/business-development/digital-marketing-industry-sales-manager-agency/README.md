# Industry Sales Manager (Agency)

A shareable OpenClaw agent folder package for **Industry Sales Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-industry-sales-manager-agency`
