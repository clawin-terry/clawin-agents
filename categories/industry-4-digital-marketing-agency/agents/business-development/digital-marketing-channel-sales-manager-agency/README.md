# Channel Sales Manager (Agency)

A shareable OpenClaw agent folder package for **Channel Sales Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-channel-sales-manager-agency`
