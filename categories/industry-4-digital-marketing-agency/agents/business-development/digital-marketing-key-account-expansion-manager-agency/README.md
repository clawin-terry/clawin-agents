# Key Account Expansion Manager (Agency)

A shareable OpenClaw agent folder package for **Key Account Expansion Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-key-account-expansion-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `business-development`
