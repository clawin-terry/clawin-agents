# Channel Mix Strategist (Agency)

A shareable OpenClaw agent folder package for **Channel Mix Strategist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-channel-mix-strategist-agency`
