# Budget Allocation and Pacing Planner (Agency)

A shareable OpenClaw agent folder package for **Budget Allocation and Pacing Planner (Agency)**.

## Package identity
- Agent ID: `digital-marketing-budget-allocation-and-pacing-planner-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `media-strategy`
