...
```text
~/.openclaw/agents/digital-marketing-data-scientist-python
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/digital-marketing-data-scientist-python`.
2. Open `config/openclaw.agent.digital-marketing-data-scientist-python.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.digital-marketing-data-scientist-python.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/digital-marketing-data-scientist-python/workspace/skills
```
...
- workspace: `~/.openclaw/agents/digital-marketing-data-scientist-python/workspace`
- agentDir: `~/.openclaw/agents/digital-marketing-data-scientist-python/agent`
