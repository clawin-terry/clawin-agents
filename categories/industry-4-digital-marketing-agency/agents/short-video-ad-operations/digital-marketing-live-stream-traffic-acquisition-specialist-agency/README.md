# Live Stream Traffic Acquisition Specialist (Agency)

A shareable OpenClaw agent folder package for **Live Stream Traffic Acquisition Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-live-stream-traffic-acquisition-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `short-video-ad-operations`
