# Short Video Ads Lead (Agency)

A shareable OpenClaw agent folder package for **Short Video Ads Lead (Agency)**.

## Package identity
- Agent ID: `digital-marketing-short-video-ads-lead-agency`
