# Growth Strategy Manager (Agency)

A shareable OpenClaw agent folder package for **Growth Strategy Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-growth-strategy-manager-agency`
