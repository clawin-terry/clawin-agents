# Recruiting Specialist (Agency)

A shareable OpenClaw agent folder package for **Recruiting Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-recruiting-specialist-agency`
