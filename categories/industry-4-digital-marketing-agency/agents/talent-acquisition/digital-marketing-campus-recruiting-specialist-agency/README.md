# Campus Recruiting Specialist (Agency)

A shareable OpenClaw agent folder package for **Campus Recruiting Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-campus-recruiting-specialist-agency`
