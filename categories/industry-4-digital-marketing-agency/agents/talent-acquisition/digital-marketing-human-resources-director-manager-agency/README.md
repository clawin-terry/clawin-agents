# Human Resources Director / Manager (Agency)

A shareable OpenClaw agent folder package for **Human Resources Director / Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-human-resources-director-manager-agency`
