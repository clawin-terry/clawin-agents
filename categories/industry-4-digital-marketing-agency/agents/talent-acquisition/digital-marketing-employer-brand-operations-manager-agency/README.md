# Employer Brand Operations Manager (Agency)

A shareable OpenClaw agent folder package for **Employer Brand Operations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-employer-brand-operations-manager-agency`
