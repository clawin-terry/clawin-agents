# Proposal Presentation Packaging Specialist (Agency)

A shareable OpenClaw agent folder package for **Proposal Presentation Packaging Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-proposal-presentation-packaging-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `commercial-bidding`
