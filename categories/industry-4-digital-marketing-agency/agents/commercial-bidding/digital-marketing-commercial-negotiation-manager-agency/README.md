# Commercial Negotiation Manager (Agency)

A shareable OpenClaw agent folder package for **Commercial Negotiation Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-commercial-negotiation-manager-agency`
