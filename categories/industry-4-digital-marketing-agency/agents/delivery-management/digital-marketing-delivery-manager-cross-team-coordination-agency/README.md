# Delivery Manager, Cross-Team Coordination (Agency)

A shareable OpenClaw agent folder package for **Delivery Manager, Cross-Team Coordination (Agency)**.

## Package identity
- Agent ID: `digital-marketing-delivery-manager-cross-team-coordination-agency`
