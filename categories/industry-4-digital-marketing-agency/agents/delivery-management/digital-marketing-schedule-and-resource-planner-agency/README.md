# Schedule and Resource Planner (Agency)

A shareable OpenClaw agent folder package for **Schedule and Resource Planner (Agency)**.

## Package identity
- Agent ID: `digital-marketing-schedule-and-resource-planner-agency`
