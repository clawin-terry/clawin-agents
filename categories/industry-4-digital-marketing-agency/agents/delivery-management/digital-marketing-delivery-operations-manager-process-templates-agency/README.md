# Delivery Operations Manager, Process and Templates (Agency)

A shareable OpenClaw agent folder package for **Delivery Operations Manager, Process and Templates (Agency)**.

## Package identity
- Agent ID: `digital-marketing-delivery-operations-manager-process-templates-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `delivery-management`
