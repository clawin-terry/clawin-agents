# Tmall and Taobao Wanxiangtai Specialist (Agency)

A shareable OpenClaw agent folder package for **Tmall and Taobao Wanxiangtai Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-tmall-taobao-wanxiangtai-specialist-agency`
