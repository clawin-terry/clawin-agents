# JD Jingzhuntong Specialist (Agency)

A shareable OpenClaw agent folder package for **JD Jingzhuntong Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-jd-jingzhuntong-specialist-agency`
