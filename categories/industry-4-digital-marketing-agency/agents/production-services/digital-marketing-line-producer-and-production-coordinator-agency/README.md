# Line Producer and Production Coordinator (Agency)

A shareable OpenClaw agent folder package for **Line Producer and Production Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-line-producer-and-production-coordinator-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `production-services`
