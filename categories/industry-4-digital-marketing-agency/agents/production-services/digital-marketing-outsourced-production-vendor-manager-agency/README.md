# Outsourced Production Vendor Manager (Agency)

A shareable OpenClaw agent folder package for **Outsourced Production Vendor Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-outsourced-production-vendor-manager-agency`
