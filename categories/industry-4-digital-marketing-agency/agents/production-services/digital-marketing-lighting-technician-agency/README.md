# Lighting Technician (Agency)

A shareable OpenClaw agent folder package for **Lighting Technician (Agency)**.

## Package identity
- Agent ID: `digital-marketing-lighting-technician-agency`
