# Creative Tracking and Naming Specialist (Agency)

A shareable OpenClaw agent folder package for **Creative Tracking and Naming Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-creative-tracking-and-naming-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `ad-operations-support`
