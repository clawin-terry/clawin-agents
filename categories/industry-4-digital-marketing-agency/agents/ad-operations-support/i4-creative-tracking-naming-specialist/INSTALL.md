...
```text
~/.openclaw/agents/i4-creative-tracking-naming-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-creative-tracking-naming-specialist`.
2. Open `config/openclaw.agent.i4-creative-tracking-naming-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-creative-tracking-naming-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-creative-tracking-naming-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-creative-tracking-naming-specialist/workspace`
- agentDir: `~/.openclaw/agents/i4-creative-tracking-naming-specialist/agent`
