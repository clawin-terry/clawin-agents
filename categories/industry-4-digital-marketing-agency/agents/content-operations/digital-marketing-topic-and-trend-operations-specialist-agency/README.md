# Topic and Trend Operations Specialist (Agency)

A shareable OpenClaw agent folder package for **Topic and Trend Operations Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-topic-and-trend-operations-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `content-operations`
