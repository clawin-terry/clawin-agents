# Editor and Staff Writer (Agency)

A shareable OpenClaw agent folder package for **Editor and Staff Writer (Agency)**.

## Package identity
- Agent ID: `digital-marketing-editor-and-staff-writer-agency`
