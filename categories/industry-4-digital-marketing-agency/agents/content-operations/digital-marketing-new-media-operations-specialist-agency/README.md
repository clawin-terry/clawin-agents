# New Media Operations Specialist (Agency)

A shareable OpenClaw agent folder package for **New Media Operations Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-new-media-operations-specialist-agency`
