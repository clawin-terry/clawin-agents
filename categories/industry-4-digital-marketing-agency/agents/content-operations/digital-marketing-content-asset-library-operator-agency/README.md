# Content Asset Library Operator (Agency)

A shareable OpenClaw agent folder package for **Content Asset Library Operator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-content-asset-library-operator-agency`
