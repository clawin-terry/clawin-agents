# Install Content Planner (Agency)
...
```text
~/.openclaw/agents/digital-marketing-content-planner-agency
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/digital-marketing-content-planner-agency`.
2. Open `config/openclaw.agent.digital-marketing-content-planner-agency.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.digital-marketing-content-planner-agency.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/digital-marketing-content-planner-agency/workspace/skills
```
...
- workspace: `~/.openclaw/agents/digital-marketing-content-planner-agency/workspace`
- agentDir: `~/.openclaw/agents/digital-marketing-content-planner-agency/agent`
