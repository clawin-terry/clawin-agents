# Platform Business Manager (Agency)

A shareable OpenClaw agent folder package for **Platform Business Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-platform-business-manager-agency`
