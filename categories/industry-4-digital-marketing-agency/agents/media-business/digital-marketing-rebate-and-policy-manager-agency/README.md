# Rebate and Policy Manager (Agency)

A shareable OpenClaw agent folder package for **Rebate and Policy Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-rebate-and-policy-manager-agency`
