# Platform Training Coordinator (Agency)

A shareable OpenClaw agent folder package for **Platform Training Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-platform-training-coordinator-agency`
