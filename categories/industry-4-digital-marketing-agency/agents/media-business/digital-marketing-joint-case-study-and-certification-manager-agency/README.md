# Joint Case Study and Certification Manager (Agency)

A shareable OpenClaw agent folder package for **Joint Case Study and Certification Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-joint-case-study-and-certification-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `media-business`
