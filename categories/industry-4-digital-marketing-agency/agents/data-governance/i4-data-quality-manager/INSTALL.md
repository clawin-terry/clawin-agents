...
```text
~/.openclaw/agents/i4-data-quality-manager
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-data-quality-manager`.
2. Open `config/openclaw.agent.i4-data-quality-manager.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-data-quality-manager.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-data-quality-manager/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-data-quality-manager/workspace`
- agentDir: `~/.openclaw/agents/i4-data-quality-manager/agent`
