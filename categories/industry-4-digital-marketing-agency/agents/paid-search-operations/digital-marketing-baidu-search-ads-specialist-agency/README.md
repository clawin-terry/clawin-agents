# Baidu Search Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **Baidu Search Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-baidu-search-ads-specialist-agency`
