# Keyword and Account Structure Optimizer (Agency)

A shareable OpenClaw agent folder package for **Keyword and Account Structure Optimizer (Agency)**.

## Package identity
- Agent ID: `digital-marketing-keyword-and-account-structure-optimizer-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `paid-search-operations`
