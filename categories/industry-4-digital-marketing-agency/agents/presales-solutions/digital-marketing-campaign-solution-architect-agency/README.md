# Campaign Solution Architect (Agency)

A shareable OpenClaw agent folder package for **Campaign Solution Architect (Agency)**.

## Package identity
- Agent ID: `digital-marketing-campaign-solution-architect-agency`
