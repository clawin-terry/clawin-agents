# Master Agreement Manager (Agency)

A shareable OpenClaw agent folder package for **Master Agreement Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-master-agreement-manager-agency`
