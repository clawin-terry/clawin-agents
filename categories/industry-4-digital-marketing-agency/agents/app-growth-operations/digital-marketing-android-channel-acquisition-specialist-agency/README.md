# Android Channel Acquisition Specialist (Agency)

A shareable OpenClaw agent folder package for **Android Channel Acquisition Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-android-channel-acquisition-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `app-growth-operations`
