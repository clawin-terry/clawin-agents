...
```text
~/.openclaw/agents/i4-tiktok-ads-specialist-agency
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-tiktok-ads-specialist-agency`.
2. Open `config/openclaw.agent.i4-tiktok-ads-specialist-agency.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-tiktok-ads-specialist-agency.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-tiktok-ads-specialist-agency/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-tiktok-ads-specialist-agency/workspace`
- agentDir: `~/.openclaw/agents/i4-tiktok-ads-specialist-agency/agent`
