# Global Landing Page and Compliance Coordinator (Agency)

A shareable OpenClaw agent folder package for **Global Landing Page and Compliance Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-global-landing-page-and-compliance-coordinator-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `global-ad-operations`
