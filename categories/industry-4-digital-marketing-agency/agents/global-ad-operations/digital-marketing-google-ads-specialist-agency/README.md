# Google Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **Google Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-google-ads-specialist-agency`
