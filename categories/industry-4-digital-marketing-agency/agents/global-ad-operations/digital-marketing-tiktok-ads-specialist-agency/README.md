# TikTok Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **TikTok Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-tiktok-ads-specialist-agency`
