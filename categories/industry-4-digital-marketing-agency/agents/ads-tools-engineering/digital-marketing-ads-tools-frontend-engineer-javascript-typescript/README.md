# Ads Tools Frontend Engineer (JavaScript/TypeScript)

A shareable OpenClaw agent folder package for **Ads Tools Frontend Engineer (JavaScript/TypeScript)**.

## Package identity
- Agent ID: `digital-marketing-ads-tools-frontend-engineer-javascript-typescript`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `ads-tools-engineering`
