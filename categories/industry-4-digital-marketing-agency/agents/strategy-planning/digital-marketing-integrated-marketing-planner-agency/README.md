# Integrated Marketing Planner (Agency)

A shareable OpenClaw agent folder package for **Integrated Marketing Planner (Agency)**.

## Package identity
- Agent ID: `digital-marketing-integrated-marketing-planner-agency`
