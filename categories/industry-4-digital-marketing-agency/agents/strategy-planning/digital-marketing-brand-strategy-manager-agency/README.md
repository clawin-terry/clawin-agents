# Brand Strategy Manager (Agency)

A shareable OpenClaw agent folder package for **Brand Strategy Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-brand-strategy-manager-agency`
