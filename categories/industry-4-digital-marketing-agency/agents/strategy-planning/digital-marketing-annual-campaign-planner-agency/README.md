# Annual Campaign Planner (Agency)

A shareable OpenClaw agent folder package for **Annual Campaign Planner (Agency)**.

## Package identity
- Agent ID: `digital-marketing-annual-campaign-planner-agency`
