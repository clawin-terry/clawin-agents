# Competitive and User Research Specialist (Agency)

A shareable OpenClaw agent folder package for **Competitive and User Research Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-competitive-and-user-research-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `strategy-planning`
