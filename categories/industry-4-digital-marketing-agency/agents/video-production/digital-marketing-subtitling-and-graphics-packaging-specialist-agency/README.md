# Subtitling and Graphics Packaging Specialist (Agency)

A shareable OpenClaw agent folder package for **Subtitling and Graphics Packaging Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-subtitling-and-graphics-packaging-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `video-production`
