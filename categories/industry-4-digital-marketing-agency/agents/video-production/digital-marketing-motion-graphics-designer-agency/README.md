# Motion Graphics Designer (Agency)

A shareable OpenClaw agent folder package for **Motion Graphics Designer (Agency)**.

## Package identity
- Agent ID: `digital-marketing-motion-graphics-designer-agency`
