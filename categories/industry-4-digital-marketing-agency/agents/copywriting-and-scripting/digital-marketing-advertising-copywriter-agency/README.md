# Advertising Copywriter (Agency)

A shareable OpenClaw agent folder package for **Advertising Copywriter (Agency)**.

## Package identity
- Agent ID: `digital-marketing-advertising-copywriter-agency`
