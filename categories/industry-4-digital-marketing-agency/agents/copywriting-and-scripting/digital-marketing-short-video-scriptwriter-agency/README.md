# Short Video Scriptwriter (Agency)

A shareable OpenClaw agent folder package for **Short Video Scriptwriter (Agency)**.

## Package identity
- Agent ID: `digital-marketing-short-video-scriptwriter-agency`
