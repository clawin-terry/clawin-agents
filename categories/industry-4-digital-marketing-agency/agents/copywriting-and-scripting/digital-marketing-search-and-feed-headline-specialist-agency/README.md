# Search and Feed Headline Specialist (Agency)

A shareable OpenClaw agent folder package for **Search and Feed Headline Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-search-and-feed-headline-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `copywriting-and-scripting`
