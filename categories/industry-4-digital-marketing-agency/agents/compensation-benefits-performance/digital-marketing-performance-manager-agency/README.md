# Performance Manager (Agency)

A shareable OpenClaw agent folder package for **Performance Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-performance-manager-agency`
