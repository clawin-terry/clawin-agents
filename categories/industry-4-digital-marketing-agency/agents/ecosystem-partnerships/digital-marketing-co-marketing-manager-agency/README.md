# Co-Marketing Manager (Agency)

A shareable OpenClaw agent folder package for **Co-Marketing Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-co-marketing-manager-agency`
