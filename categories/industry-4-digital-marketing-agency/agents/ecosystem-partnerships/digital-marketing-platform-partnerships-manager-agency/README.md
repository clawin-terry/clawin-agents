# Platform Partnerships Manager (Agency)

A shareable OpenClaw agent folder package for **Platform Partnerships Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-platform-partnerships-manager-agency`
