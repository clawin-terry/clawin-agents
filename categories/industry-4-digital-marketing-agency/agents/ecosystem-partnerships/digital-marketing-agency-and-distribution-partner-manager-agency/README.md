# Agency and Distribution Partner Manager (Agency)

A shareable OpenClaw agent folder package for **Agency and Distribution Partner Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-agency-and-distribution-partner-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `ecosystem-partnerships`
