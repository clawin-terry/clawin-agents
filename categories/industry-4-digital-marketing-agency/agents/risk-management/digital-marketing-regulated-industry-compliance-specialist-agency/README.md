# Industry Compliance Specialist, Regulated Sectors (Agency)

A shareable OpenClaw agent folder package for **Industry Compliance Specialist, Regulated Sectors (Agency)**.

## Package identity
- Agent ID: `digital-marketing-regulated-industry-compliance-specialist-agency`
