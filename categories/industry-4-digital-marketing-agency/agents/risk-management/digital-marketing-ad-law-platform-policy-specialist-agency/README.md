# Advertising Law and Platform Policy Enablement Specialist (Agency)

A shareable OpenClaw agent folder package for **Advertising Law and Platform Policy Enablement Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-ad-law-platform-policy-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `risk-management`
