# Employment Legal Support Specialist

A shareable OpenClaw agent folder package for **Employment Legal Support Specialist**.

## Package identity
- Agent ID: `digital-marketing-employment-legal-support-specialist-agency`
