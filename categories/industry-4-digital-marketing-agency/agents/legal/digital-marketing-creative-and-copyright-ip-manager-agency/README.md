# Creative and Copyright IP Manager

A shareable OpenClaw agent folder package for **Creative and Copyright IP Manager**.

## Package identity
- Agent ID: `digital-marketing-creative-and-copyright-ip-manager-agency`
