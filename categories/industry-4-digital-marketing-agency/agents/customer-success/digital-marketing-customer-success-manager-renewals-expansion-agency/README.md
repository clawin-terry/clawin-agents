# Customer Success Manager, Renewals and Expansion (Agency)

A shareable OpenClaw agent folder package for **Customer Success Manager, Renewals and Expansion (Agency)**.

## Package identity
- Agent ID: `digital-marketing-customer-success-manager-renewals-expansion-agency`
