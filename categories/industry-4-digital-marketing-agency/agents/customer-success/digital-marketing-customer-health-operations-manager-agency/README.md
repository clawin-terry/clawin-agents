# Customer Health Operations Manager (Agency)

A shareable OpenClaw agent folder package for **Customer Health Operations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-customer-health-operations-manager-agency`
