# Customer Training and Enablement Manager (Agency)

A shareable OpenClaw agent folder package for **Customer Training and Enablement Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-customer-training-and-enablement-manager-agency`
