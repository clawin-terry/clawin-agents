# Customer Success Lead (Agency)

A shareable OpenClaw agent folder package for **Customer Success Lead (Agency)**.

## Package identity
- Agent ID: `digital-marketing-customer-success-lead-agency`
