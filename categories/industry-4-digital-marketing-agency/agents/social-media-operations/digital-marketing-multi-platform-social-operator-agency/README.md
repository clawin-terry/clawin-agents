# Multi-Platform Social Operator (Agency)

A shareable OpenClaw agent folder package for **Multi-Platform Social Operator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-multi-platform-social-operator-agency`
