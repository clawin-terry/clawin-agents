# Install Methodology Lead (Agency)
...
```text
~/.openclaw/agents/digital-marketing-methodology-lead-agency
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/digital-marketing-methodology-lead-agency`.
2. Open `config/openclaw.agent.digital-marketing-methodology-lead-agency.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.digital-marketing-methodology-lead-agency.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/digital-marketing-methodology-lead-agency/workspace/skills
```
...
- workspace: `~/.openclaw/agents/digital-marketing-methodology-lead-agency/workspace`
- agentDir: `~/.openclaw/agents/digital-marketing-methodology-lead-agency/agent`
