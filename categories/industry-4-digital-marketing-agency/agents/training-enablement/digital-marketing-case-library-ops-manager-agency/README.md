# Case Library and Battlecard Operations Manager (Agency)

A shareable OpenClaw agent folder package for **Case Library and Battlecard Operations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-case-library-ops-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `training-enablement`
