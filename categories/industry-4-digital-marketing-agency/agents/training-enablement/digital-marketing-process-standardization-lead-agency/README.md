# Process Standardization Lead (Agency)

A shareable OpenClaw agent folder package for **Process Standardization Lead (Agency)**.

## Package identity
- Agent ID: `digital-marketing-process-standardization-lead-agency`
