# Professional Skills Certification Program Manager (Agency)

A shareable OpenClaw agent folder package for **Professional Skills Certification Program Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-professional-skills-certification-program-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `learning-development`
