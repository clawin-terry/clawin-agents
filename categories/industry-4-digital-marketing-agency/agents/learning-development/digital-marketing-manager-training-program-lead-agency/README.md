# Manager Training Program Lead (Agency)

A shareable OpenClaw agent folder package for **Manager Training Program Lead (Agency)**.

## Package identity
- Agent ID: `digital-marketing-manager-training-program-lead-agency`
