# Mentorship Program Manager (Agency)

A shareable OpenClaw agent folder package for **Mentorship Program Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-mentorship-program-manager-agency`
