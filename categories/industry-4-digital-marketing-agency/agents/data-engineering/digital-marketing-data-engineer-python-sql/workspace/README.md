# Data Engineer (Python/SQL) workspace

This workspace powers the **Data Engineer (Python/SQL)** OpenClaw agent.
...
## Example prompts
- "Act as a Data Engineer (Python/SQL) and help me with a concrete task. Reply with Plan -> Files -> Output -> Verify."
