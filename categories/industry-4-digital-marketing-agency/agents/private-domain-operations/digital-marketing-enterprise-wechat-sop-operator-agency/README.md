# Enterprise WeChat SOP Operator (Agency)

A shareable OpenClaw agent folder package for **Enterprise WeChat SOP Operator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-enterprise-wechat-sop-operator-agency`
