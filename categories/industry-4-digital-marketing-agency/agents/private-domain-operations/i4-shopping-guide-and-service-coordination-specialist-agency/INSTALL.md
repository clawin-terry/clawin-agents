...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-shopping-guide-and-service-coordination-specialist-agency`.
2. Open `config/openclaw.agent.i4-shopping-guide-and-service-coordination-specialist-agency.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-shopping-guide-and-service-coordination-specialist-agency.snippet.json` into the target config instead.
...
- workspace: `~/.openclaw/agents/i4-shopping-guide-and-service-coordination-specialist-agency/workspace`
- agentDir: `~/.openclaw/agents/i4-shopping-guide-and-service-coordination-specialist-agency/agent`
