# Shopping Guide and Service Coordination Specialist (Agency)

A shareable OpenClaw agent folder package for **Shopping Guide and Service Coordination Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-shopping-guide-and-service-coordination-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `private-domain-operations`
