...
A shareable OpenClaw agent folder package for **Accounts Receivable and Payable Accountant**.

## Package identity
- Agent ID: `digital-marketing-accounts-receivable-and-payable-accountant-agency`
