# Content Marketing Manager (Agency)

A shareable OpenClaw agent folder package for **Content Marketing Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-content-marketing-manager-agency`
