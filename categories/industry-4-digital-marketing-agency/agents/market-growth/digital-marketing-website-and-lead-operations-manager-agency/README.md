# Website and Lead Operations Manager (Agency)

A shareable OpenClaw agent folder package for **Website and Lead Operations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-website-and-lead-operations-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `market-growth`
