# Events and Conferences Manager (Agency)

A shareable OpenClaw agent folder package for **Events and Conferences Manager (Agency)**.

## Package identity
- Agent ID: `i4-events-and-conferences-manager-agency`
