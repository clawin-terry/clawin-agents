# Marketing Design Support Specialist (Agency)

A shareable OpenClaw agent folder package for **Marketing Design Support Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-marketing-design-support-specialist-agency`
