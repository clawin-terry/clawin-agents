# Public Relations Manager (Agency)

A shareable OpenClaw agent folder package for **Public Relations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-public-relations-manager-agency`
