# Marketing Director / Manager (Agency)

A shareable OpenClaw agent folder package for **Marketing Director / Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-marketing-director-manager-agency`
