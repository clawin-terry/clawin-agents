# MTA and Incrementality Testing Specialist

A shareable OpenClaw agent folder package for **MTA and Incrementality Testing Specialist**.

## Package identity
- Agent ID: `digital-marketing-mta-and-incrementality-testing-specialist`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `attribution-measurement`
