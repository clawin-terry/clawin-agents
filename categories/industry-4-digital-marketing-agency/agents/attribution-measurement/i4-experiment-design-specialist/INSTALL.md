...
```text
~/.openclaw/agents/i4-experiment-design-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-experiment-design-specialist`.
2. Open `config/openclaw.agent.i4-experiment-design-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-experiment-design-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-experiment-design-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-experiment-design-specialist/workspace`
- agentDir: `~/.openclaw/agents/i4-experiment-design-specialist/agent`
