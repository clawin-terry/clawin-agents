...
```text
~/.openclaw/agents/i4-head-of-attribution-and-measurement
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-head-of-attribution-and-measurement`.
2. Open `config/openclaw.agent.i4-head-of-attribution-and-measurement.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-head-of-attribution-and-measurement.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-head-of-attribution-and-measurement/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-head-of-attribution-and-measurement/workspace`
- agentDir: `~/.openclaw/agents/i4-head-of-attribution-and-measurement/agent`
