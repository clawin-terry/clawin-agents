# Head of Attribution and Measurement

A shareable OpenClaw agent folder package for **Head of Attribution and Measurement**.

## Package identity
- Agent ID: `digital-marketing-head-of-attribution-and-measurement`
