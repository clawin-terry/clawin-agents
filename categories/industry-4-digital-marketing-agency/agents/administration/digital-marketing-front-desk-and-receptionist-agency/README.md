# Front Desk and Receptionist (Agency)

A shareable OpenClaw agent folder package for **Front Desk and Receptionist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-front-desk-and-receptionist-agency`
