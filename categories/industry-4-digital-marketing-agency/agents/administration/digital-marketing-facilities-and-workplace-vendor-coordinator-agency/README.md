# Facilities and Workplace Vendor Coordinator (Agency)

A shareable OpenClaw agent folder package for **Facilities and Workplace Vendor Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-facilities-and-workplace-vendor-coordinator-agency`
