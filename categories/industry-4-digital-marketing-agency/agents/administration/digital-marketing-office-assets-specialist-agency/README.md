# Office Assets Specialist (Agency)

A shareable OpenClaw agent folder package for **Office Assets Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-office-assets-specialist-agency`
