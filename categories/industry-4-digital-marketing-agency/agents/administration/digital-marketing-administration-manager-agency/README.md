# Administration Manager (Agency)

A shareable OpenClaw agent folder package for **Administration Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-administration-manager-agency`
