# Organization Development Manager (Agency)

A shareable OpenClaw agent folder package for **Organization Development Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-organization-development-manager-agency`
