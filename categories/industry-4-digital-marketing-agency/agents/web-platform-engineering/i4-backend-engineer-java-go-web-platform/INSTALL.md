...
```text
~/.openclaw/agents/i4-backend-engineer-java-go-web-platform
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-backend-engineer-java-go-web-platform`.
2. Open `config/openclaw.agent.i4-backend-engineer-java-go-web-platform.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-backend-engineer-java-go-web-platform.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-backend-engineer-java-go-web-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-backend-engineer-java-go-web-platform/workspace`
- agentDir: `~/.openclaw/agents/i4-backend-engineer-java-go-web-platform/agent`
