...
A shareable OpenClaw agent folder package for **Frontend Engineer (JavaScript/TypeScript)**.

## Package identity
- Agent ID: `digital-marketing-frontend-engineer-javascript-typescript`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `web-platform-engineering`
