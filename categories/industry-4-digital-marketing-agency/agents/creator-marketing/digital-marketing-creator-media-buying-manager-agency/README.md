# Creator Media Buying Manager (Agency)

A shareable OpenClaw agent folder package for **Creator Media Buying Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-creator-media-buying-manager-agency`
