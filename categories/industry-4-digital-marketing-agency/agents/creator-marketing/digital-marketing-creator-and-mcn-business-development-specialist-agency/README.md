# Creator and MCN Business Development Specialist (Agency)

A shareable OpenClaw agent folder package for **Creator and MCN Business Development Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-creator-and-mcn-business-development-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `creator-marketing`
