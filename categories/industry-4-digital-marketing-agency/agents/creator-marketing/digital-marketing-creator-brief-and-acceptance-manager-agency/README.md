# Creator Brief and Acceptance Manager (Agency)

A shareable OpenClaw agent folder package for **Creator Brief and Acceptance Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-creator-brief-and-acceptance-manager-agency`
