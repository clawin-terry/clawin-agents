# Creator Selection and Negotiation Specialist (Agency)

A shareable OpenClaw agent folder package for **Creator Selection and Negotiation Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-creator-selection-and-negotiation-specialist-agency`
