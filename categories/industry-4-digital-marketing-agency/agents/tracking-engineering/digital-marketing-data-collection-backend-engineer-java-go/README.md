# Data Collection Backend Engineer (Java/Go)

A shareable OpenClaw agent folder package for **Data Collection Backend Engineer (Java/Go)**.

## Package identity
- Agent ID: `digital-marketing-data-collection-backend-engineer-java-go`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `tracking-engineering`
