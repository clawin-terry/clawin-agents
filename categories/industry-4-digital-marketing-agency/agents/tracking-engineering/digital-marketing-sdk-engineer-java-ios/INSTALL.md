# Install SDK Engineer (Java, Objective-C, and Swift)
...
```text
~/.openclaw/agents/digital-marketing-sdk-engineer-java-ios
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/digital-marketing-sdk-engineer-java-ios`.
2. Open `config/openclaw.agent.digital-marketing-sdk-engineer-java-ios.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.digital-marketing-sdk-engineer-java-ios.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/digital-marketing-sdk-engineer-java-ios/workspace/skills
```
...
- workspace: `~/.openclaw/agents/digital-marketing-sdk-engineer-java-ios/workspace`
- agentDir: `~/.openclaw/agents/digital-marketing-sdk-engineer-java-ios/agent`
