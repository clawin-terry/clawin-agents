# MarTech Product Manager (CDP, Marketing Automation, BI, Attribution, and Asset Management)

A shareable OpenClaw agent folder package for **MarTech Product Manager (CDP, Marketing Automation, BI, Attribution, and Asset Management)**.

## Package identity
- Agent ID: `digital-marketing-martech-product-manager-core-stack`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `product-management`
