# Milestone and Risk Manager (Agency)

A shareable OpenClaw agent folder package for **Milestone and Risk Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-milestone-and-risk-manager-agency`
