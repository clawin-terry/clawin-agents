# Project Management Director (Agency)

A shareable OpenClaw agent folder package for **Project Management Director (Agency)**.

## Package identity
- Agent ID: `i4-project-management-director-agency`
