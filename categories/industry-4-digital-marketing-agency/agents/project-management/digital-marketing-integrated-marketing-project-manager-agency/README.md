# Integrated Marketing Project Manager (Agency)

A shareable OpenClaw agent folder package for **Integrated Marketing Project Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-integrated-marketing-project-manager-agency`
