# Project Assistant / Coordinator (Agency)

A shareable OpenClaw agent folder package for **Project Assistant / Coordinator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-project-assistant-coordinator-agency`
