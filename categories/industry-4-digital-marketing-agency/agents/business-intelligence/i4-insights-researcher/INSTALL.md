...
```text
~/.openclaw/agents/i4-insights-researcher
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i4-insights-researcher`.
2. Open `config/openclaw.agent.i4-insights-researcher.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i4-insights-researcher.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i4-insights-researcher/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i4-insights-researcher/workspace`
- agentDir: `~/.openclaw/agents/i4-insights-researcher/agent`
