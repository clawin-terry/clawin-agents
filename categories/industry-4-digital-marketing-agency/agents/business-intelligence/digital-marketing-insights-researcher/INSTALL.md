...
```text
~/.openclaw/agents/digital-marketing-insights-researcher
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/digital-marketing-insights-researcher`.
2. Open `config/openclaw.agent.digital-marketing-insights-researcher.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.digital-marketing-insights-researcher.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/digital-marketing-insights-researcher/workspace/skills
```
...
- workspace: `~/.openclaw/agents/digital-marketing-insights-researcher/workspace`
- agentDir: `~/.openclaw/agents/digital-marketing-insights-researcher/agent`
