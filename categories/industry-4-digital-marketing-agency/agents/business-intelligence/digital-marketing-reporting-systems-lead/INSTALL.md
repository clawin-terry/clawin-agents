# Install Reporting Systems Lead
...
```text
~/.openclaw/agents/digital-marketing-reporting-systems-lead
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/digital-marketing-reporting-systems-lead`.
2. Open `config/openclaw.agent.digital-marketing-reporting-systems-lead.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.digital-marketing-reporting-systems-lead.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/digital-marketing-reporting-systems-lead/workspace/skills
```
...
- workspace: `~/.openclaw/agents/digital-marketing-reporting-systems-lead/workspace`
- agentDir: `~/.openclaw/agents/digital-marketing-reporting-systems-lead/agent`
