# Payment Term and Collections Coordinator

A shareable OpenClaw agent folder package for **Payment Term and Collections Coordinator**.

## Package identity
- Agent ID: `digital-marketing-payment-term-and-collections-coordinator-agency`
