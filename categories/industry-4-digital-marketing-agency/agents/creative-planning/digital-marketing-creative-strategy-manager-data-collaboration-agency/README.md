# Creative Strategy Manager, Data Collaboration (Agency)

A shareable OpenClaw agent folder package for **Creative Strategy Manager, Data Collaboration (Agency)**.

## Package identity
- Agent ID: `digital-marketing-creative-strategy-manager-data-collaboration-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `creative-planning`
