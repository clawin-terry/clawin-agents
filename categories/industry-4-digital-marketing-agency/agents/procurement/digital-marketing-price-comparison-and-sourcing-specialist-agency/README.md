# Price Comparison and Sourcing Specialist (Agency)

A shareable OpenClaw agent folder package for **Price Comparison and Sourcing Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-price-comparison-and-sourcing-specialist-agency`
