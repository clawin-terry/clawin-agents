# Outsourced Production Supplier Manager (Agency)

A shareable OpenClaw agent folder package for **Outsourced Production Supplier Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-outsourced-production-supplier-manager-agency`
