# Contract Register Coordination Specialist (Agency)

A shareable OpenClaw agent folder package for **Contract Register Coordination Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-contract-register-coordination-specialist-agency`
