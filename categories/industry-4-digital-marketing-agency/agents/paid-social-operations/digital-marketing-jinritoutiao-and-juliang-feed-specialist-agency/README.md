# Jinri Toutiao and Ocean Engine Feed Ads Specialist (Agency)

A shareable OpenClaw agent folder package for **Jinri Toutiao and Ocean Engine Feed Ads Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-jinritoutiao-and-juliang-feed-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `paid-social-operations`
