# Delivery Sampling Auditor (Agency)

A shareable OpenClaw agent folder package for **Delivery Sampling Auditor (Agency)**.

## Package identity
- Agent ID: `digital-marketing-delivery-sampling-auditor-agency`
