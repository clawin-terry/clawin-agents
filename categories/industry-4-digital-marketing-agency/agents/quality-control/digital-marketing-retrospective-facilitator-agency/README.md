# Retrospective Facilitator (Agency)

A shareable OpenClaw agent folder package for **Retrospective Facilitator (Agency)**.

## Package identity
- Agent ID: `digital-marketing-retrospective-facilitator-agency`
