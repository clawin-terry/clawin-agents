# Campaign Review Quality Specialist, Links Assets Compliance and Naming (Agency)

A shareable OpenClaw agent folder package for **Campaign Review Quality Specialist, Links Assets Compliance and Naming (Agency)**.

## Package identity
- Agent ID: `digital-marketing-campaign-qc-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `quality-control`
