# Industry Portfolio Lead (Agency)

A shareable OpenClaw agent folder package for **Industry Portfolio Lead (Agency)**.

## Package identity
- Agent ID: `digital-marketing-industry-portfolio-lead-agency`
