# Client Director / Group Head (Agency)

A shareable OpenClaw agent folder package for **Client Director / Group Head (Agency)**.

## Package identity
- Agent ID: `digital-marketing-client-director-group-head-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `account-management`
