# Senior Visual Designer (Agency)

A shareable OpenClaw agent folder package for **Senior Visual Designer (Agency)**.

## Package identity
- Agent ID: `digital-marketing-senior-visual-designer-agency`
