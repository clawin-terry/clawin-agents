# Feed and Ecommerce Key Visual Designer (Agency)

A shareable OpenClaw agent folder package for **Feed and Ecommerce Key Visual Designer (Agency)**.

## Package identity
- Agent ID: `digital-marketing-feed-and-ecommerce-key-visual-designer-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `design-production`
