# Layout and Adaptation Designer (Agency)

A shareable OpenClaw agent folder package for **Layout and Adaptation Designer (Agency)**.

## Package identity
- Agent ID: `digital-marketing-layout-and-adaptation-designer-agency`
