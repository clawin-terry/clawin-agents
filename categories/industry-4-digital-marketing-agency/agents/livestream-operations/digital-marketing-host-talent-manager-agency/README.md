# Host Talent Manager (Agency)

A shareable OpenClaw agent folder package for **Host Talent Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-host-talent-manager-agency`
