# Livestream Floor Manager (Agency)

A shareable OpenClaw agent folder package for **Livestream Floor Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-livestream-floor-manager-agency`
