# Livestream Show Director (Agency)

A shareable OpenClaw agent folder package for **Livestream Show Director (Agency)**.

## Package identity
- Agent ID: `digital-marketing-livestream-show-director-agency`
