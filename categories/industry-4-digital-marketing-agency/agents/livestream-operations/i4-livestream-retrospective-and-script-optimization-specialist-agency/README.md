# Livestream Retrospective and Script Optimization Specialist (Agency)

A shareable OpenClaw agent folder package for **Livestream Retrospective and Script Optimization Specialist (Agency)**.

## Package identity
- Agent ID: `i4-livestream-retrospective-and-script-optimization-specialist-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `livestream-operations`
