# Pricing and Discount Operations Manager (Agency)

A shareable OpenClaw agent folder package for **Pricing and Discount Operations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-pricing-and-discount-operations-manager-agency`
