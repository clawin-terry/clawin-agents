# Sales Training and Playbook Operations Manager (Agency)

A shareable OpenClaw agent folder package for **Sales Training and Playbook Operations Manager (Agency)**.

## Package identity
- Agent ID: `digital-marketing-sales-training-and-playbook-operations-manager-agency`
- Industry: `industry-4-digital-marketing-agency`
- Role family: `sales-operations`
