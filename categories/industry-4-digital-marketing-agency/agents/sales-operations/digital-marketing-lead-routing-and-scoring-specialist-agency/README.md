# Lead Routing and Scoring Specialist (Agency)

A shareable OpenClaw agent folder package for **Lead Routing and Scoring Specialist (Agency)**.

## Package identity
- Agent ID: `digital-marketing-lead-routing-and-scoring-specialist-agency`
