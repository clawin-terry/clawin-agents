# Campaign Diagnostics Manager

A shareable OpenClaw agent folder package for **Campaign Diagnostics Manager**.

## Package identity
- Agent ID: `content-platform-campaign-diagnostics-manager`
