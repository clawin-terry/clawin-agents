# Install Merchant Growth Advisor
...
```text
~/.openclaw/agents/content-platform-merchant-growth-advisor
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-merchant-growth-advisor`.
2. Open `config/openclaw.agent.content-platform-merchant-growth-advisor.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-merchant-growth-advisor.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-merchant-growth-advisor/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-merchant-growth-advisor/workspace`
- agentDir: `~/.openclaw/agents/content-platform-merchant-growth-advisor/agent`
