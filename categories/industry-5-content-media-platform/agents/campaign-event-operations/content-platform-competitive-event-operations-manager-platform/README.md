# Competitive Event Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Competitive Event Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-competitive-event-operations-manager-platform`
