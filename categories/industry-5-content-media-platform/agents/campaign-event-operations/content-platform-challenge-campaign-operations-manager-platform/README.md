# Challenge Campaign Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Challenge Campaign Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-challenge-campaign-operations-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `campaign-event-operations`
