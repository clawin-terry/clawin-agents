# IP Collaboration Project Manager (Platform)

A shareable OpenClaw agent folder package for **IP Collaboration Project Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-ip-collaboration-project-manager-platform`
