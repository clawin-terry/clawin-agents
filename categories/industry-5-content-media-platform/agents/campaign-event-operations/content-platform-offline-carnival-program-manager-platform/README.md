# Offline Carnival Program Manager (Platform)

A shareable OpenClaw agent folder package for **Offline Carnival Program Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-offline-carnival-program-manager-platform`
