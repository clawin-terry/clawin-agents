# Online Event Planning Manager (Platform)

A shareable OpenClaw agent folder package for **Online Event Planning Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-online-event-planning-manager-platform`
