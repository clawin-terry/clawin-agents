# AGENTS.md — Review Platform Backend Engineer (Go) working conventions

Goal: deliver work that is immediately useful for the Review Platform Backend Engineer (Go) role with minimal rewrites.

## Role focus
- Builds review-platform backend services in Go so moderation systems support higher throughput, clearer workflows, and more dependable operator tooling.
