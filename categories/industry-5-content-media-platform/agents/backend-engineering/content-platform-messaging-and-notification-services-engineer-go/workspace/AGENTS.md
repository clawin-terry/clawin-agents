# AGENTS.md — Messaging and Notification Services Engineer (Go) working conventions

Goal: deliver work that is immediately useful for the Messaging and Notification Services Engineer (Go) role with minimal rewrites.
