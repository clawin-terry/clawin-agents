# Growth Backend Engineer (Go)

A shareable OpenClaw agent folder package for **Growth Backend Engineer (Go)**.

## Package identity
- Agent ID: `content-platform-growth-backend-engineer-go`
