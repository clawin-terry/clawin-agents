# AGENTS.md — Growth Backend Engineer (Go) working conventions

Goal: deliver work that is immediately useful for the Growth Backend Engineer (Go) role with minimal rewrites.

## Role focus
- Builds Go backend services for growth systems so activation, retention, and campaign capabilities can scale with reliable platform integrations.
