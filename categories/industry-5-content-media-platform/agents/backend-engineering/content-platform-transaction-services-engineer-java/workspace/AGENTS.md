# AGENTS.md — Transaction Services Engineer (Java) working conventions

Goal: deliver work that is immediately useful for the Transaction Services Engineer (Java) role with minimal rewrites.
