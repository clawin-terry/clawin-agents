# AGENTS.md — Search Services and Indexing Engineer (Java) working conventions

Goal: deliver work that is immediately useful for the Search Services and Indexing Engineer (Java) role with minimal rewrites.

## Role focus
- Builds Java search services and indexing systems so retrieval infrastructure, query execution, and indexing workflows remain scalable and easier to operate.
