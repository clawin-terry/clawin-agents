...
```text
~/.openclaw/agents/i5-audio-video-services-engineer-cpp
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i5-audio-video-services-engineer-cpp`.
2. Open `config/openclaw.agent.i5-audio-video-services-engineer-cpp.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i5-audio-video-services-engineer-cpp.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i5-audio-video-services-engineer-cpp/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i5-audio-video-services-engineer-cpp/workspace`
- agentDir: `~/.openclaw/agents/i5-audio-video-services-engineer-cpp/agent`
