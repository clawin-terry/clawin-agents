# Ad Retrieval and Matching Engineer (Go)

A shareable OpenClaw agent folder package for **Ad Retrieval and Matching Engineer (Go)**.

## Package identity
- Agent ID: `content-platform-ad-retrieval-and-matching-engineer-go`
