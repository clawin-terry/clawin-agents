# AGENTS.md — Payment Reconciliation and Risk Collaboration Engineer (Java) working conventions

Goal: deliver work that is immediately useful for the Payment Reconciliation and Risk Collaboration Engineer (Java) role with minimal rewrites.

## Role focus
- Builds Java services for payment reconciliation and risk collaboration so financial records, exception handling, and risk-control handoffs stay accurate and auditable.
