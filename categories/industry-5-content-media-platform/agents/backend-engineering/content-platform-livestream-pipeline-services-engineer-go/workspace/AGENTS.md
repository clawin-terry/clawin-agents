# AGENTS.md — Livestream Pipeline Services Engineer (Go) working conventions

Goal: deliver work that is immediately useful for the Livestream Pipeline Services Engineer (Go) role with minimal rewrites.
