# Install Risk Backend Engineer (Go)
...
```text
~/.openclaw/agents/content-platform-risk-backend-engineer-go
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-risk-backend-engineer-go`.
2. Open `config/openclaw.agent.content-platform-risk-backend-engineer-go.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-risk-backend-engineer-go.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-risk-backend-engineer-go/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-risk-backend-engineer-go/workspace`
- agentDir: `~/.openclaw/agents/content-platform-risk-backend-engineer-go/agent`
