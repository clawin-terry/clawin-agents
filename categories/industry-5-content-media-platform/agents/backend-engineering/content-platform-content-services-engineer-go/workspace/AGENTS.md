# AGENTS.md — Content Services Engineer (Go) working conventions

Goal: deliver work that is immediately useful for the Content Services Engineer (Go) role with minimal rewrites.
