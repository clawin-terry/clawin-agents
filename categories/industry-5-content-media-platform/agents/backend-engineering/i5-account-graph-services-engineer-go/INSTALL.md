...
```text
~/.openclaw/agents/i5-account-graph-services-engineer-go
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i5-account-graph-services-engineer-go`.
2. Open `config/openclaw.agent.i5-account-graph-services-engineer-go.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i5-account-graph-services-engineer-go.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i5-account-graph-services-engineer-go/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i5-account-graph-services-engineer-go/workspace`
- agentDir: `~/.openclaw/agents/i5-account-graph-services-engineer-go/agent`
