# Rules Engine Engineer (Java)

A shareable OpenClaw agent folder package for **Rules Engine Engineer (Java)**.

## Package identity
- Agent ID: `content-platform-rules-engine-engineer-java`
