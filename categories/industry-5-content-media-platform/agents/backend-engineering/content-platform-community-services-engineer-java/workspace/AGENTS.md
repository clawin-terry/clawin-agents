# AGENTS.md — Community Services Engineer (Java) working conventions

Goal: deliver work that is immediately useful for the Community Services Engineer (Java) role with minimal rewrites.
