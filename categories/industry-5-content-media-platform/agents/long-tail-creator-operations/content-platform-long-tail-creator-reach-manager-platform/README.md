# Long-Tail Creator Reach Manager (Platform)

A shareable OpenClaw agent folder package for **Long-Tail Creator Reach Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-long-tail-creator-reach-manager-platform`
