# Creator Messaging and Push Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Messaging and Push Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-messaging-and-push-operations-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `long-tail-creator-operations`
