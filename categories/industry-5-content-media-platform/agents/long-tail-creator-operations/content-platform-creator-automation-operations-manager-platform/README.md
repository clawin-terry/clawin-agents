# Creator Automation Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Automation Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-automation-operations-manager-platform`
