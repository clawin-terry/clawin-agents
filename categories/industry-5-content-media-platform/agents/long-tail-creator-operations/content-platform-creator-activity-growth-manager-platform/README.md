# Creator Activity Growth Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Activity Growth Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-activity-growth-manager-platform`
