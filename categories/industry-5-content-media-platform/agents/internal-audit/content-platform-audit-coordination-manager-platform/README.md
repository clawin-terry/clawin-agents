# Audit Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Audit Coordination Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-audit-coordination-manager-platform`
