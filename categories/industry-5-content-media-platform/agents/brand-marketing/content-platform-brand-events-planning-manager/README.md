# Brand Events Planning Manager

A shareable OpenClaw agent folder package for **Brand Events Planning Manager**.

## Package identity
- Agent ID: `content-platform-brand-events-planning-manager`
- Industry: `industry-5-content-media-platform`
- Role family: `brand-marketing`
