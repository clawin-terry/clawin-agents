# Budget and Budget Control Manager (Platform)

A shareable OpenClaw agent folder package for **Budget and Budget Control Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-budget-and-budget-control-manager-platform`
