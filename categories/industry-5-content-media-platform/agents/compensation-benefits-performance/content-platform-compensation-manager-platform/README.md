# Compensation Manager (Platform)

A shareable OpenClaw agent folder package for **Compensation Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-compensation-manager-platform`
