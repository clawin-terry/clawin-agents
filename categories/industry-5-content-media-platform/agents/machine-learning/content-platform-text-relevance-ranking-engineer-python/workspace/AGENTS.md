# AGENTS.md — Text Relevance and Ranking Engineer (Python) working conventions

Goal: deliver work that is immediately useful for the Text Relevance and Ranking Engineer (Python) role with minimal rewrites.
