# AGENTS.md — Ad Fraud and Invalid Traffic Detection Engineer (Python) working conventions

Goal: deliver work that is immediately useful for the Ad Fraud and Invalid Traffic Detection Engineer (Python) role with minimal rewrites.
