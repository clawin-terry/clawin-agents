# AGENTS.md — Embedding and Vector Retrieval Engineer (Python) working conventions

Goal: deliver work that is immediately useful for the Embedding and Vector Retrieval Engineer (Python) role with minimal rewrites.
