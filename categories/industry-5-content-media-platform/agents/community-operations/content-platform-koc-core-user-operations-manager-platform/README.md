# KOC and Core User Operations Manager (Platform)

A shareable OpenClaw agent folder package for **KOC and Core User Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-koc-core-user-operations-manager-platform`
