# Group and Circle Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Group and Circle Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-group-and-circle-operations-manager-platform`
