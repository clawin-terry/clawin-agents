# Topic Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Topic Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-topic-operations-manager-platform`
