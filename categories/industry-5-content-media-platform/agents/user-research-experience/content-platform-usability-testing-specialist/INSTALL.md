...
```text
~/.openclaw/agents/content-platform-usability-testing-specialist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-usability-testing-specialist`.
2. Open `config/openclaw.agent.content-platform-usability-testing-specialist.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-usability-testing-specialist.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-usability-testing-specialist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-usability-testing-specialist/workspace`
- agentDir: `~/.openclaw/agents/content-platform-usability-testing-specialist/agent`
