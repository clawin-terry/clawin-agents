# Capture, Editing, and Effects Product Manager

A shareable OpenClaw agent folder package for **Capture, Editing, and Effects Product Manager**.

## Package identity
- Agent ID: `content-platform-capture-editing-and-effects-product-manager`
