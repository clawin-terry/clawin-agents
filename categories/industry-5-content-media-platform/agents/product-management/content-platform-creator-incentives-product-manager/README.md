# Creator Incentives Product Manager

A shareable OpenClaw agent folder package for **Creator Incentives Product Manager**.

## Package identity
- Agent ID: `content-platform-creator-incentives-product-manager`
