# Retrieval and Ranking Objectives Product Manager

A shareable OpenClaw agent folder package for **Retrieval and Ranking Objectives Product Manager**.

## Package identity
- Agent ID: `content-platform-retrieval-and-ranking-objectives-product-manager`
