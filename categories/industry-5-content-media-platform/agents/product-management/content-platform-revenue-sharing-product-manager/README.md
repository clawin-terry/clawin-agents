# Revenue Sharing Product Manager

A shareable OpenClaw agent folder package for **Revenue Sharing Product Manager**.

## Package identity
- Agent ID: `content-platform-revenue-sharing-product-manager`
