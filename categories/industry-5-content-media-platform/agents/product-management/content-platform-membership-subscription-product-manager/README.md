# Membership Subscription Product Manager

A shareable OpenClaw agent folder package for **Membership Subscription Product Manager**.

## Package identity
- Agent ID: `content-platform-membership-subscription-product-manager`
