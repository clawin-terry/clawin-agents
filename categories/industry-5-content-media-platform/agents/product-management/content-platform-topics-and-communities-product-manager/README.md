# Topics and Communities Product Manager

A shareable OpenClaw agent folder package for **Topics and Communities Product Manager**.

## Package identity
- Agent ID: `content-platform-topics-and-communities-product-manager`
