# Retention and Reactivation Product Manager

A shareable OpenClaw agent folder package for **Retention and Reactivation Product Manager**.

## Package identity
- Agent ID: `content-platform-retention-and-reactivation-product-manager`
