# Feed and Immersive Playback Product Manager

A shareable OpenClaw agent folder package for **Feed and Immersive Playback Product Manager**.

## Package identity
- Agent ID: `content-platform-feed-and-immersive-playback-product-manager`
