# Cold Start Strategy Product Manager

A shareable OpenClaw agent folder package for **Cold Start Strategy Product Manager**.

## Package identity
- Agent ID: `content-platform-cold-start-strategy-product-manager`
