# Referrals and Invitations Product Manager

A shareable OpenClaw agent folder package for **Referrals and Invitations Product Manager**.

## Package identity
- Agent ID: `content-platform-referrals-and-invitations-product-manager`
