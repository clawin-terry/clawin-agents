# Community Governance Product Manager

A shareable OpenClaw agent folder package for **Community Governance Product Manager**.

## Package identity
- Agent ID: `content-platform-community-governance-product-manager`
