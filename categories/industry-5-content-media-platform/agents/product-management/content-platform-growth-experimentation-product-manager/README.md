# Growth Experimentation Product Manager

A shareable OpenClaw agent folder package for **Growth Experimentation Product Manager**.

## Package identity
- Agent ID: `content-platform-growth-experimentation-product-manager`
