# Publishing Workflow Product Manager

A shareable OpenClaw agent folder package for **Publishing Workflow Product Manager**.

## Package identity
- Agent ID: `content-platform-publishing-workflow-product-manager`
