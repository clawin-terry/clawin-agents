# Live Interaction Mechanics Product Manager

A shareable OpenClaw agent folder package for **Live Interaction Mechanics Product Manager**.

## Package identity
- Agent ID: `content-platform-live-interaction-mechanics-product-manager`
