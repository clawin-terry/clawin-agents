# Recommendation Strategy Product Manager

A shareable OpenClaw agent folder package for **Recommendation Strategy Product Manager**.

## Package identity
- Agent ID: `content-platform-recommendation-strategy-product-manager`
