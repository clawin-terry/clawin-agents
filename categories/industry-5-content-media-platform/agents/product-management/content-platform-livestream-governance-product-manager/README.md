# Livestream Governance Product Manager

A shareable OpenClaw agent folder package for **Livestream Governance Product Manager**.

## Package identity
- Agent ID: `content-platform-livestream-governance-product-manager`
