# Direct Messaging and Group Chat Product Manager

A shareable OpenClaw agent folder package for **Direct Messaging and Group Chat Product Manager**.

## Package identity
- Agent ID: `content-platform-direct-messaging-and-group-chat-product-manager`
