# Follow and Fan Graph Product Manager

A shareable OpenClaw agent folder package for **Follow and Fan Graph Product Manager**.

## Package identity
- Agent ID: `content-platform-follow-and-fan-graph-product-manager`
