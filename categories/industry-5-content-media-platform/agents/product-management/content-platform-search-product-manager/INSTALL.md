# Install Search Product Manager
...
```text
~/.openclaw/agents/content-platform-search-product-manager
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-search-product-manager`.
2. Open `config/openclaw.agent.content-platform-search-product-manager.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-search-product-manager.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-search-product-manager/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-search-product-manager/workspace`
- agentDir: `~/.openclaw/agents/content-platform-search-product-manager/agent`
