# Livestream Room Product Manager

A shareable OpenClaw agent folder package for **Livestream Room Product Manager**.

## Package identity
- Agent ID: `content-platform-livestream-room-product-manager`
