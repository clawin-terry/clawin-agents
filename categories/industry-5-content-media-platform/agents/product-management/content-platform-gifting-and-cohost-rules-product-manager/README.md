# Gifting and Co-Host Rules Product Manager

A shareable OpenClaw agent folder package for **Gifting and Co-Host Rules Product Manager**.

## Package identity
- Agent ID: `content-platform-gifting-and-cohost-rules-product-manager`
