# Personal Data Protection Manager (Platform)

A shareable OpenClaw agent folder package for **Personal Data Protection Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-personal-data-protection-manager-platform`
