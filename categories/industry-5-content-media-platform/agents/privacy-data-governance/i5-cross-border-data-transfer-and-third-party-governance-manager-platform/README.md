# Cross-Border Data Transfer and Third-Party Governance Manager (Platform)

A shareable OpenClaw agent folder package for **Cross-Border Data Transfer and Third-Party Governance Manager (Platform)**.

## Package identity
- Agent ID: `i5-cross-border-data-transfer-and-third-party-governance-manager-platform`
