# Cross-Border Data Governance Manager (Platform)

A shareable OpenClaw agent folder package for **Cross-Border Data Governance Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-cross-border-data-governance-manager-platform`
