# Personal Information Protection Manager (Platform)

A shareable OpenClaw agent folder package for **Personal Information Protection Manager (Platform)**.

## Package identity
- Agent ID: `i5-personal-information-protection-manager-platform`
