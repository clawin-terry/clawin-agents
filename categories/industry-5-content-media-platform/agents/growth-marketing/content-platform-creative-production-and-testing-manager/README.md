# Creative Production and Testing Manager

A shareable OpenClaw agent folder package for **Creative Production and Testing Manager**.

## Package identity
- Agent ID: `content-platform-creative-production-and-testing-manager`
- Industry: `industry-5-content-media-platform`
- Role family: `growth-marketing`
