# Penalties and Appeals Product Manager

A shareable OpenClaw agent folder package for **Penalties and Appeals Product Manager**.

## Package identity
- Agent ID: `content-platform-penalties-and-appeals-product-manager`
