# Risk Dashboard Product Manager

A shareable OpenClaw agent folder package for **Risk Dashboard Product Manager**.

## Package identity
- Agent ID: `content-platform-risk-dashboard-product-manager`
