# Review Workbench Product Manager

A shareable OpenClaw agent folder package for **Review Workbench Product Manager**.

## Package identity
- Agent ID: `content-platform-review-workbench-product-manager`
