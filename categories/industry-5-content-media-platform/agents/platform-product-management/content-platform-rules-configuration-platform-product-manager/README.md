# Rules Configuration Platform Product Manager

A shareable OpenClaw agent folder package for **Rules Configuration Platform Product Manager**.

## Package identity
- Agent ID: `content-platform-rules-configuration-platform-product-manager`
