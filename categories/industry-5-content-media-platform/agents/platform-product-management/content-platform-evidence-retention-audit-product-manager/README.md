# Evidence Retention and Audit Product Manager

A shareable OpenClaw agent folder package for **Evidence Retention and Audit Product Manager**.

## Package identity
- Agent ID: `content-platform-evidence-retention-audit-product-manager`
