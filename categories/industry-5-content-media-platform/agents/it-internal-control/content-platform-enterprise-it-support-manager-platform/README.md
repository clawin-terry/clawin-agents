# Enterprise IT Support Manager (Platform)

A shareable OpenClaw agent folder package for **Enterprise IT Support Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-enterprise-it-support-manager-platform`
