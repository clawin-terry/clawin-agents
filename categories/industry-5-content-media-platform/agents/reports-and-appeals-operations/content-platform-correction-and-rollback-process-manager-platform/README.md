# Correction and Rollback Process Manager (Platform)

A shareable OpenClaw agent folder package for **Correction and Rollback Process Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-correction-and-rollback-process-manager-platform`
