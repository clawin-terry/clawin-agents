# Penalty Communication Template Manager (Platform)

A shareable OpenClaw agent folder package for **Penalty Communication Template Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-penalty-communication-template-manager-platform`
