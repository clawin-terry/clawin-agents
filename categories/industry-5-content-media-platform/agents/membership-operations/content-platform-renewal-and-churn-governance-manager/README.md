# Renewal and Churn Governance Manager

A shareable OpenClaw agent folder package for **Renewal and Churn Governance Manager**.

## Package identity
- Agent ID: `content-platform-renewal-and-churn-governance-manager`
