# Minor Protection Policy Manager (Platform)

A shareable OpenClaw agent folder package for **Minor Protection Policy Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-minor-protection-policy-manager-platform`
