# Privacy and Sensitive Information Policy Manager (Platform)

A shareable OpenClaw agent folder package for **Privacy and Sensitive Information Policy Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-privacy-and-sensitive-information-policy-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `policy-and-safety-standards`
