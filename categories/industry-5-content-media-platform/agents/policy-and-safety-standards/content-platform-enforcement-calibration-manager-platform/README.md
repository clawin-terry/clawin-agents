# Enforcement Calibration Manager (Platform)

A shareable OpenClaw agent folder package for **Enforcement Calibration Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-enforcement-calibration-manager-platform`
