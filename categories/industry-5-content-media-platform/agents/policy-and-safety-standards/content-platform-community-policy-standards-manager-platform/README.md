# Community Policy Standards Manager (Platform)

A shareable OpenClaw agent folder package for **Community Policy Standards Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-community-policy-standards-manager-platform`
