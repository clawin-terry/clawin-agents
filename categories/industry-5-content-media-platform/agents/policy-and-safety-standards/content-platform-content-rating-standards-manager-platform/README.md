# Content Rating Standards Manager (Platform)

A shareable OpenClaw agent folder package for **Content Rating Standards Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-rating-standards-manager-platform`
