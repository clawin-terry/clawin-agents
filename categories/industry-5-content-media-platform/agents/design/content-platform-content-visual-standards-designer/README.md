# Content Visual Standards Designer

A shareable OpenClaw agent folder package for **Content Visual Standards Designer**.

## Package identity
- Agent ID: `content-platform-content-visual-standards-designer`
