...
```text
~/.openclaw/agents/content-platform-ux-writer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-ux-writer`.
2. Open `config/openclaw.agent.content-platform-ux-writer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-ux-writer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-ux-writer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-ux-writer/workspace`
- agentDir: `~/.openclaw/agents/content-platform-ux-writer/agent`
