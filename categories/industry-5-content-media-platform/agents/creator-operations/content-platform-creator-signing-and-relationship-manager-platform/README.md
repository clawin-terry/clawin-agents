# Creator Signing and Relationship Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Signing and Relationship Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-signing-and-relationship-manager-platform`
