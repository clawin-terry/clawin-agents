# Creator Guidelines Communications Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Guidelines Communications Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-guidelines-communications-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `creator-education-enablement`
