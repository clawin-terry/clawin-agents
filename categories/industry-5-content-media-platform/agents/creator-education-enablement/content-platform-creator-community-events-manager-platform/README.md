# Creator Community Events Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Community Events Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-community-events-manager-platform`
