# Review Sampling and Quality Specialist (Platform)

A shareable OpenClaw agent folder package for **Review Sampling and Quality Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-review-sampling-quality-specialist-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `video-review-operations`
