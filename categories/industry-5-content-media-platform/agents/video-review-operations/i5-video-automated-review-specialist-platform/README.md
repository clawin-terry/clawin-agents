# Video Automated Review Specialist (Platform)

A shareable OpenClaw agent folder package for **Video Automated Review Specialist (Platform)**.

## Package identity
- Agent ID: `i5-video-automated-review-specialist-platform`
