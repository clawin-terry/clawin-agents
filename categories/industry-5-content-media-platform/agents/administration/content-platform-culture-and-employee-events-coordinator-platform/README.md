# Culture and Employee Events Coordinator (Platform)

A shareable OpenClaw agent folder package for **Culture and Employee Events Coordinator (Platform)**.

## Package identity
- Agent ID: `content-platform-culture-and-employee-events-coordinator-platform`
