# Administration Manager (Platform)

A shareable OpenClaw agent folder package for **Administration Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-administration-manager-platform`
