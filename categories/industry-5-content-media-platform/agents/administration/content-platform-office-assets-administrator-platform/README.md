# Office Assets Administrator (Platform)

A shareable OpenClaw agent folder package for **Office Assets Administrator (Platform)**.

## Package identity
- Agent ID: `content-platform-office-assets-administrator-platform`
