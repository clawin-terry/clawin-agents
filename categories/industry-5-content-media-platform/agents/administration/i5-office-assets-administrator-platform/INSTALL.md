...
```text
~/.openclaw/agents/i5-office-assets-administrator-platform
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i5-office-assets-administrator-platform`.
2. Open `config/openclaw.agent.i5-office-assets-administrator-platform.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i5-office-assets-administrator-platform.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i5-office-assets-administrator-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i5-office-assets-administrator-platform/workspace`
- agentDir: `~/.openclaw/agents/i5-office-assets-administrator-platform/agent`
