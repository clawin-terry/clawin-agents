# Install Key Account Sales Manager
...
```text
~/.openclaw/agents/content-platform-key-account-sales-manager
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-key-account-sales-manager`.
2. Open `config/openclaw.agent.content-platform-key-account-sales-manager.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-key-account-sales-manager.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-key-account-sales-manager/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-key-account-sales-manager/workspace`
- agentDir: `~/.openclaw/agents/content-platform-key-account-sales-manager/agent`
