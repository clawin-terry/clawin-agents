# Reporting Funnel Operations Coordinator (Platform)

A shareable OpenClaw agent folder package for **Reporting Funnel Operations Coordinator (Platform)**.

## Package identity
- Agent ID: `content-platform-reporting-funnel-operations-coordinator-platform`
