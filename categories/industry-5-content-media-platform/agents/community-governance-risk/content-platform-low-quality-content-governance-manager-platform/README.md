# Low-Quality Content Governance Manager (Platform)

A shareable OpenClaw agent folder package for **Low-Quality Content Governance Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-low-quality-content-governance-manager-platform`
