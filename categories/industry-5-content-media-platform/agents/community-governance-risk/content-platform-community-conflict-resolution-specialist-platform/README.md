# Community Conflict Resolution Specialist (Platform)

A shareable OpenClaw agent folder package for **Community Conflict Resolution Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-community-conflict-resolution-specialist-platform`
