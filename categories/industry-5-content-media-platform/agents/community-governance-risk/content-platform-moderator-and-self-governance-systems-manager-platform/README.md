# Moderator and Self-Governance Systems Manager (Platform)

A shareable OpenClaw agent folder package for **Moderator and Self-Governance Systems Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-moderator-and-self-governance-systems-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `community-governance-risk`
