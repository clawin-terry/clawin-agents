# Merchandising and Platform Acquisition Manager

A shareable OpenClaw agent folder package for **Merchandising and Platform Acquisition Manager**.

## Package identity
- Agent ID: `content-platform-merchandising-and-platform-acquisition-manager`
