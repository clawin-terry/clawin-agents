# Promotions and Major Campaign Operations Manager

A shareable OpenClaw agent folder package for **Promotions and Major Campaign Operations Manager**.

## Package identity
- Agent ID: `content-platform-promotions-and-major-campaign-operations-manager`
