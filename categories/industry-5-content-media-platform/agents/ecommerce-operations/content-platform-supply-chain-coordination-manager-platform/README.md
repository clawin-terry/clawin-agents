# Supply Chain Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Supply Chain Coordination Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-supply-chain-coordination-manager-platform`
