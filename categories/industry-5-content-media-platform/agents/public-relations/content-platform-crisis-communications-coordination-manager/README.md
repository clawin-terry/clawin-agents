# Crisis Communications Coordination Manager

A shareable OpenClaw agent folder package for **Crisis Communications Coordination Manager**.

## Package identity
- Agent ID: `content-platform-crisis-communications-coordination-manager`
