# Pirated Reupload Governance Manager (Platform)

A shareable OpenClaw agent folder package for **Pirated Reupload Governance Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-pirated-reupload-governance-manager-platform`
