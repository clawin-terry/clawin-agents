# Copyright Partnership BD Manager (Platform)

A shareable OpenClaw agent folder package for **Copyright Partnership BD Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-copyright-partnership-bd-manager-platform`
