# AGENTS.md — Copyright Partnership BD Manager (Platform) working conventions

Goal: deliver work that is immediately useful for the Copyright Partnership BD Manager (Platform) role with minimal rewrites.
