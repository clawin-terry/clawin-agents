# Content Licensing Manager (Platform)

A shareable OpenClaw agent folder package for **Content Licensing Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-licensing-manager-platform`
