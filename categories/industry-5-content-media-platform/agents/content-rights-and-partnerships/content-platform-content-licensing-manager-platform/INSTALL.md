...
```text
~/.openclaw/agents/content-platform-content-licensing-manager-platform
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-content-licensing-manager-platform`.
...
```text
~/.openclaw/agents/content-platform-content-licensing-manager-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-content-licensing-manager-platform/workspace`
- agentDir: `~/.openclaw/agents/content-platform-content-licensing-manager-platform/agent`
