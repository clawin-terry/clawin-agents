# Copyright Asset Operations Coordinator (Platform)

A shareable OpenClaw agent folder package for **Copyright Asset Operations Coordinator (Platform)**.

## Package identity
- Agent ID: `content-platform-copyright-asset-ops-coordinator-platform`
