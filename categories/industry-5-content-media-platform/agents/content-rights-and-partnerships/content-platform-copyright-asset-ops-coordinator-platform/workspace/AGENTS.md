# AGENTS.md — Copyright Asset Operations Coordinator (Platform) working conventions

Goal: deliver work that is immediately useful for the Copyright Asset Operations Coordinator (Platform) role with minimal rewrites.
