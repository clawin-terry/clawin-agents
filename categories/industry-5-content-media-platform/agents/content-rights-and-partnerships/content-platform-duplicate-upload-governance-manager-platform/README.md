# Duplicate Upload Governance Manager (Platform)

A shareable OpenClaw agent folder package for **Duplicate Upload Governance Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-duplicate-upload-governance-manager-platform`
