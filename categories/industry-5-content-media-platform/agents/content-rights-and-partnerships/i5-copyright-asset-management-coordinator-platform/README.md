# Copyright Asset Management Coordinator (Platform)

A shareable OpenClaw agent folder package for **Copyright Asset Management Coordinator (Platform)**.

## Package identity
- Agent ID: `i5-copyright-asset-management-coordinator-platform`
