# Content Acquisition Manager (Platform)

A shareable OpenClaw agent folder package for **Content Acquisition Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-acquisition-manager-platform`
