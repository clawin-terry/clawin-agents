# AGENTS.md — Content Acquisition Manager (Platform) working conventions

Goal: deliver work that is immediately useful for the Content Acquisition Manager (Platform) role with minimal rewrites.
