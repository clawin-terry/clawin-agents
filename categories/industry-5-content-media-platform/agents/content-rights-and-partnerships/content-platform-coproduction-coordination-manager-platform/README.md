# Co-Production Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Co-Production Coordination Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-coproduction-coordination-manager-platform`
