# Infringement Response Coordinator (Platform)

A shareable OpenClaw agent folder package for **Infringement Response Coordinator (Platform)**.

## Package identity
- Agent ID: `content-platform-infringement-response-coordinator-platform`
