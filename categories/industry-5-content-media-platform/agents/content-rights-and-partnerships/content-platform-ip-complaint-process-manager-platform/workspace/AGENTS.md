# AGENTS.md — IP Complaint Process Manager (Platform) working conventions

Goal: deliver work that is immediately useful for the IP Complaint Process Manager (Platform) role with minimal rewrites.
