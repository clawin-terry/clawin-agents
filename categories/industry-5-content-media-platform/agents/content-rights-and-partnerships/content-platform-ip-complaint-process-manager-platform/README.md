# IP Complaint Process Manager (Platform)

A shareable OpenClaw agent folder package for **IP Complaint Process Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-ip-complaint-process-manager-platform`
