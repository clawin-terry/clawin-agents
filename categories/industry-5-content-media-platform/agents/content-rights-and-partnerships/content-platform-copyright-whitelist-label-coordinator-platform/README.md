# Copyright Whitelist and Authorization Label Coordinator (Platform)

A shareable OpenClaw agent folder package for **Copyright Whitelist and Authorization Label Coordinator (Platform)**.

## Package identity
- Agent ID: `content-platform-copyright-whitelist-label-coordinator-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `content-rights-and-partnerships`
