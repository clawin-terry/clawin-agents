# Infringement Process Manager (Platform)

A shareable OpenClaw agent folder package for **Infringement Process Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-infringement-process-manager-platform`
