# AGENTS.md — Review Consistency Analyst (Platform) working conventions

Goal: deliver work that is immediately useful for the Review Consistency Analyst (Platform) role with minimal rewrites.

## Role focus
- Analyzes review consistency so moderation judgments, escalations, and policy interpretations stay aligned across reviewer cohorts and changing risk conditions.
