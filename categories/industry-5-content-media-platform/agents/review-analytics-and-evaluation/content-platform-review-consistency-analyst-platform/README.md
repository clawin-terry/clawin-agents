# Review Consistency Analyst (Platform)

A shareable OpenClaw agent folder package for **Review Consistency Analyst (Platform)**.

## Package identity
- Agent ID: `content-platform-review-consistency-analyst-platform`
