# Ecosystem Metrics Framework Lead (Platform)

A shareable OpenClaw agent folder package for **Ecosystem Metrics Framework Lead (Platform)**.

## Package identity
- Agent ID: `content-platform-ecosystem-metrics-framework-lead-platform`
