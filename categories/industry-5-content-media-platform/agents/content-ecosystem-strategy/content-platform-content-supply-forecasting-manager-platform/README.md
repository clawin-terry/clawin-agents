# Content Supply Forecasting Manager (Platform)

A shareable OpenClaw agent folder package for **Content Supply Forecasting Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-supply-forecasting-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `content-ecosystem-strategy`
