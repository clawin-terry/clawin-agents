# Category Planning Manager (Platform)

A shareable OpenClaw agent folder package for **Category Planning Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-category-planning-manager-platform`
