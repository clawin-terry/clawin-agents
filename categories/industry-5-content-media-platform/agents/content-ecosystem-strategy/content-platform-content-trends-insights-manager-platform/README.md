# Content Trends and Insights Manager (Platform)

A shareable OpenClaw agent folder package for **Content Trends and Insights Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-trends-insights-manager-platform`
