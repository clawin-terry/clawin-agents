# Content Supply Strategy Manager (Platform)

A shareable OpenClaw agent folder package for **Content Supply Strategy Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-supply-strategy-manager-platform`
