# Livestream Ban Policy Executor (Platform)

A shareable OpenClaw agent folder package for **Livestream Ban Policy Executor (Platform)**.

## Package identity
- Agent ID: `content-platform-livestream-ban-policy-executor-platform`
