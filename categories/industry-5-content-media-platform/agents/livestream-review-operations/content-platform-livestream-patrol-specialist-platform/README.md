# Livestream Patrol Specialist (Platform)

A shareable OpenClaw agent folder package for **Livestream Patrol Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-livestream-patrol-specialist-platform`
