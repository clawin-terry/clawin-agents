# Live Connection and PK Risk Specialist (Platform)

A shareable OpenClaw agent folder package for **Live Connection and PK Risk Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-live-connection-pk-risk-specialist-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `livestream-review-operations`
