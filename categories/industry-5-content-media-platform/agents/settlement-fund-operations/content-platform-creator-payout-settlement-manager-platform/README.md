# Creator Payout Settlement Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Payout Settlement Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-payout-settlement-manager-platform`
