# Install Editor-in-Chief (Platform)
...
```text
~/.openclaw/agents/content-platform-editor-in-chief-platform
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-editor-in-chief-platform`.
2. Open `config/openclaw.agent.content-platform-editor-in-chief-platform.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-editor-in-chief-platform.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-editor-in-chief-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-editor-in-chief-platform/workspace`
- agentDir: `~/.openclaw/agents/content-platform-editor-in-chief-platform/agent`
