# AGENTS.md — Editor-in-Chief (Platform) working conventions

Goal: deliver work that is immediately useful for the Editor-in-Chief (Platform) role with minimal rewrites.
