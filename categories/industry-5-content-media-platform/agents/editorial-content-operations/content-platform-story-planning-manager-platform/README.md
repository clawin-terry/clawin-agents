# Story Planning Manager (Platform)

A shareable OpenClaw agent folder package for **Story Planning Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-story-planning-manager-platform`
