# Editorial Policy and Prepublication Review Manager (Platform)

A shareable OpenClaw agent folder package for **Editorial Policy and Prepublication Review Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-editorial-policy-and-prepublication-review-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `editorial-content-operations`
