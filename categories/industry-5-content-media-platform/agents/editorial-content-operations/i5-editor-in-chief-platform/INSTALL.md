...
```text
~/.openclaw/agents/i5-editor-in-chief-platform
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/i5-editor-in-chief-platform`.
2. Open `config/openclaw.agent.i5-editor-in-chief-platform.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.i5-editor-in-chief-platform.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/i5-editor-in-chief-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/i5-editor-in-chief-platform/workspace`
- agentDir: `~/.openclaw/agents/i5-editor-in-chief-platform/agent`
