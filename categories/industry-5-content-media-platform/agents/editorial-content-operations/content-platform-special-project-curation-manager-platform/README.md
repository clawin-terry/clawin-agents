# Special Project Curation Manager (Platform)

A shareable OpenClaw agent folder package for **Special Project Curation Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-special-project-curation-manager-platform`
