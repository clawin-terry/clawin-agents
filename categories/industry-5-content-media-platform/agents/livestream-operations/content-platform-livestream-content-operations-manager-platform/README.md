# Livestream Content Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Livestream Content Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-livestream-content-operations-manager-platform`
