# Live Room Engagement Mechanics Manager (Platform)

A shareable OpenClaw agent folder package for **Live Room Engagement Mechanics Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-live-room-engagement-mechanics-manager-platform`
