# Livestream Event Planning Manager (Platform)

A shareable OpenClaw agent folder package for **Livestream Event Planning Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-livestream-event-planning-manager-platform`
