# Guild Operations Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Guild Operations Coordination Manager (Platform)**.

## Package identity
- Agent ID: `i5-guild-operations-coordination-manager-platform`
