# Supplier Management Manager (Platform)

A shareable OpenClaw agent folder package for **Supplier Management Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-supplier-management-manager-platform`
