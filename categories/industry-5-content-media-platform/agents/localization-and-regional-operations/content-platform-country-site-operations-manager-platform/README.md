# Country Site Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Country Site Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-country-site-operations-manager-platform`
