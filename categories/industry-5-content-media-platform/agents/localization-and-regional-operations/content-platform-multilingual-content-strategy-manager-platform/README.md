# Multilingual Content Strategy Manager (Platform)

A shareable OpenClaw agent folder package for **Multilingual Content Strategy Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-multilingual-content-strategy-manager-platform`
