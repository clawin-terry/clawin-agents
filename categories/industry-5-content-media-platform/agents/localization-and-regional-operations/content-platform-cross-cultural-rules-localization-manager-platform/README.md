# Cross-Cultural Rules Localization Manager (Platform)

A shareable OpenClaw agent folder package for **Cross-Cultural Rules Localization Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-cross-cultural-rules-localization-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `localization-and-regional-operations`
