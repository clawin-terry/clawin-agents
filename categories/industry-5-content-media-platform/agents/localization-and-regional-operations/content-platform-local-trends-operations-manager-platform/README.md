# Local Trends Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Local Trends Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-local-trends-operations-manager-platform`
