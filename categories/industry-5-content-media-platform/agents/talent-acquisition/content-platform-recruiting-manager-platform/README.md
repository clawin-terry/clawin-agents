# Recruiting Manager (Platform)

A shareable OpenClaw agent folder package for **Recruiting Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-recruiting-manager-platform`
