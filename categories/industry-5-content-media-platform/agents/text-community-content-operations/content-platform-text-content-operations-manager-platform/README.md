# Text Content Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Text Content Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-text-content-operations-manager-platform`
