# Content Structure Governance Manager (Platform)

A shareable OpenClaw agent folder package for **Content Structure Governance Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-structure-governance-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `text-community-content-operations`
