# Q&A and Post Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Q&A and Post Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-qa-and-post-operations-manager-platform`
