# Vertical Content Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Vertical Content Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-vertical-content-operations-manager-platform`
