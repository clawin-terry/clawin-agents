# Programming Schedule Planning Manager (Platform)

A shareable OpenClaw agent folder package for **Programming Schedule Planning Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-programming-schedule-planning-manager-platform`
