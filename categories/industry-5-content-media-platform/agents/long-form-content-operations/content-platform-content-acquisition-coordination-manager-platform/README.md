# Content Acquisition Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Content Acquisition Coordination Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-acquisition-coordination-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `long-form-content-operations`
