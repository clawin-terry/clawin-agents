# Content Promotion Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Content Promotion Coordination Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-promotion-coordination-manager-platform`
