# Premium Content Program Manager (Platform)

A shareable OpenClaw agent folder package for **Premium Content Program Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-premium-content-program-manager-platform`
