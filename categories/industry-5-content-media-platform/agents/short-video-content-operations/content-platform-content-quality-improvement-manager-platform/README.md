# Content Quality Improvement Manager (Platform)

A shareable OpenClaw agent folder package for **Content Quality Improvement Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-quality-improvement-manager-platform`
