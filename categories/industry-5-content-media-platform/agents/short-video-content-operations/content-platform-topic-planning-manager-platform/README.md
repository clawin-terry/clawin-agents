# Topic Planning Manager (Platform)

A shareable OpenClaw agent folder package for **Topic Planning Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-topic-planning-manager-platform`
