# Trending Content Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Trending Content Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-trending-content-operations-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `short-video-content-operations`
