# Install iOS Client Engineer (Swift)
...
```text
~/.openclaw/agents/content-platform-ios-client-engineer-swift
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-ios-client-engineer-swift`.
2. Open `config/openclaw.agent.content-platform-ios-client-engineer-swift.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-ios-client-engineer-swift.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-ios-client-engineer-swift/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-ios-client-engineer-swift/workspace`
- agentDir: `~/.openclaw/agents/content-platform-ios-client-engineer-swift/agent`
