# Traffic Benefits Design Manager (Platform)

A shareable OpenClaw agent folder package for **Traffic Benefits Design Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-traffic-benefits-design-manager-platform`
