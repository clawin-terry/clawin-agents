# Creator Subsidy and Campaign Budget Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Subsidy and Campaign Budget Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-subsidy-and-campaign-budget-manager-platform`
