# Creator Incentive Policy Manager (Platform)

A shareable OpenClaw agent folder package for **Creator Incentive Policy Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-incentive-policy-manager-platform`
