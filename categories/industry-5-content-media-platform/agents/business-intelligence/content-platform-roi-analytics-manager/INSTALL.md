...
```text
~/.openclaw/agents/content-platform-roi-analytics-manager
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-roi-analytics-manager`.
2. Open `config/openclaw.agent.content-platform-roi-analytics-manager.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-roi-analytics-manager.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-roi-analytics-manager/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-roi-analytics-manager/workspace`
- agentDir: `~/.openclaw/agents/content-platform-roi-analytics-manager/agent`
