# Install Performance Test Engineer
...
```text
~/.openclaw/agents/content-platform-performance-test-engineer
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-performance-test-engineer`.
2. Open `config/openclaw.agent.content-platform-performance-test-engineer.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-performance-test-engineer.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-performance-test-engineer/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-performance-test-engineer/workspace`
- agentDir: `~/.openclaw/agents/content-platform-performance-test-engineer/agent`
