# Bidding and Tendering Specialist (Platform)

A shareable OpenClaw agent folder package for **Bidding and Tendering Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-bidding-and-tendering-specialist-platform`
