# Institution Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Institution Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-institution-operations-manager-platform`
