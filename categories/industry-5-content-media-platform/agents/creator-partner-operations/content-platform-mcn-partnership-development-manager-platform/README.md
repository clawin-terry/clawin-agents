# MCN Partnership Development Manager (Platform)

A shareable OpenClaw agent folder package for **MCN Partnership Development Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-mcn-partnership-development-manager-platform`
