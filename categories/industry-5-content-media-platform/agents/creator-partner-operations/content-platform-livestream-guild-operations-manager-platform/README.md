# Livestream Guild Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Livestream Guild Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-livestream-guild-operations-manager-platform`
