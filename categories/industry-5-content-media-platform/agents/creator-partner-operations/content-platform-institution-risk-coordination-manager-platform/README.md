# Institution Risk Coordination Manager (Platform)

A shareable OpenClaw agent folder package for **Institution Risk Coordination Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-institution-risk-coordination-manager-platform`
