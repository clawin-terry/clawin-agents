# Advertising Solutions Sales Manager

A shareable OpenClaw agent folder package for **Advertising Solutions Sales Manager**.

## Package identity
- Agent ID: `i5-advertising-solutions-sales-manager`
- Industry: `industry-5-content-media-platform`
- Role family: `pre-sales`
