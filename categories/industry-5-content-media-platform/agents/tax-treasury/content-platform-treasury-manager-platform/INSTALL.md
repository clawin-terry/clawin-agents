# Install Treasury Manager (Platform)
...
```text
~/.openclaw/agents/content-platform-treasury-manager-platform
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-treasury-manager-platform`.
2. Open `config/openclaw.agent.content-platform-treasury-manager-platform.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-treasury-manager-platform.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-treasury-manager-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-treasury-manager-platform/workspace`
- agentDir: `~/.openclaw/agents/content-platform-treasury-manager-platform/agent`
