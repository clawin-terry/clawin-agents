# Content Support Strategy Manager (Platform)

A shareable OpenClaw agent folder package for **Content Support Strategy Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-content-support-strategy-manager-platform`
