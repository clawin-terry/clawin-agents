# Install Contract Counsel (Platform)
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-contract-counsel-platform`.
2. Open `config/openclaw.agent.content-platform-contract-counsel-platform.entry.json`.
3. Append that JSON object to `agents.list` in the target machine's `~/.openclaw/openclaw.json`.
4. If you prefer a wrapper snippet, merge `config/openclaw.agent.content-platform-contract-counsel-platform.snippet.json` into the target config instead.
...
```text
~/.openclaw/agents/content-platform-contract-counsel-platform/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-contract-counsel-platform/workspace`
- agentDir: `~/.openclaw/agents/content-platform-contract-counsel-platform/agent`
