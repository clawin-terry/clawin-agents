# Dispute Resolution Counsel (Platform)

A shareable OpenClaw agent folder package for **Dispute Resolution Counsel (Platform)**.

## Package identity
- Agent ID: `content-platform-dispute-resolution-counsel-platform`
