# Employment Legal Support Specialist (Platform)

A shareable OpenClaw agent folder package for **Employment Legal Support Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-employment-legal-support-specialist-platform`
