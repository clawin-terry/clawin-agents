# General Ledger Accountant (Platform)

A shareable OpenClaw agent folder package for **General Ledger Accountant (Platform)**.

## Package identity
- Agent ID: `content-platform-general-ledger-accountant-platform`
