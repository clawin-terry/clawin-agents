# Business Unit HRBP (Platform)

A shareable OpenClaw agent folder package for **Business Unit HRBP (Platform)**.

## Package identity
- Agent ID: `content-platform-business-unit-hrbp-platform`
