# Organization Development Manager (Platform)

A shareable OpenClaw agent folder package for **Organization Development Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-org-development-manager-platform`
