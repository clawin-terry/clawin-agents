...
```text
~/.openclaw/agents/content-platform-device-ip-risk-strategist
```
...
## Steps
1. Copy this entire folder to `~/.openclaw/agents/content-platform-device-ip-risk-strategist`.
...
```text
~/.openclaw/agents/content-platform-device-ip-risk-strategist/workspace/skills
```
...
- workspace: `~/.openclaw/agents/content-platform-device-ip-risk-strategist/workspace`
- agentDir: `~/.openclaw/agents/content-platform-device-ip-risk-strategist/agent`
