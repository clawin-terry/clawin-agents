# Knowledge Base Operations Specialist (Platform)

A shareable OpenClaw agent folder package for **Knowledge Base Operations Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-knowledge-base-operations-specialist-platform`
