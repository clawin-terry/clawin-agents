# Creator Support Specialist (Platform)

A shareable OpenClaw agent folder package for **Creator Support Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-creator-support-specialist-platform`
