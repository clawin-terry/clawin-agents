# Merchant Support Specialist (Platform)

A shareable OpenClaw agent folder package for **Merchant Support Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-merchant-support-specialist-platform`
