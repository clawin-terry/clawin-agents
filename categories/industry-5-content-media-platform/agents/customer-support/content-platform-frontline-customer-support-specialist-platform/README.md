# Frontline Customer Support Specialist (Platform)

A shareable OpenClaw agent folder package for **Frontline Customer Support Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-frontline-customer-support-specialist-platform`
