# Service Quality and Training Manager (Platform)

A shareable OpenClaw agent folder package for **Service Quality and Training Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-service-quality-and-training-manager-platform`
