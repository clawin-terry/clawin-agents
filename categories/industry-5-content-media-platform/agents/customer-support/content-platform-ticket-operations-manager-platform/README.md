# Ticket Operations Manager (Platform)

A shareable OpenClaw agent folder package for **Ticket Operations Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-ticket-operations-manager-platform`
