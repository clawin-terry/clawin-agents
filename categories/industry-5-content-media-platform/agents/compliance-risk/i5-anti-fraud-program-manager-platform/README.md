# Anti-Fraud Program Manager (Platform)

A shareable OpenClaw agent folder package for **Anti-Fraud Program Manager (Platform)**.

## Package identity
- Agent ID: `i5-anti-fraud-program-manager-platform`
