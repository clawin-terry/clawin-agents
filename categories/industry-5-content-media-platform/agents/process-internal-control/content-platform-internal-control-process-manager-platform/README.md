# Internal Control Process Manager (Platform)

A shareable OpenClaw agent folder package for **Internal Control Process Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-internal-control-process-manager-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `process-internal-control`
