# Advertising Product Operations Manager

A shareable OpenClaw agent folder package for **Advertising Product Operations Manager**.

## Package identity
- Agent ID: `content-platform-advertising-product-operations-manager`
