# Campaign Strategy Operations Manager

A shareable OpenClaw agent folder package for **Campaign Strategy Operations Manager**.

## Package identity
- Agent ID: `content-platform-campaign-strategy-operations-manager`
