# Text and Image Review Specialist (Platform)

A shareable OpenClaw agent folder package for **Text and Image Review Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-text-and-image-review-specialist-platform`
