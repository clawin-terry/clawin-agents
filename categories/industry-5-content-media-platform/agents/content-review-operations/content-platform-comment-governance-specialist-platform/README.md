# Comment Governance Specialist (Platform)

A shareable OpenClaw agent folder package for **Comment Governance Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-comment-governance-specialist-platform`
