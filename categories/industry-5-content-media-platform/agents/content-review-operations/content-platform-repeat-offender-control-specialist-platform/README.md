# Repeat Offender Control Specialist (Platform)

A shareable OpenClaw agent folder package for **Repeat Offender Control Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-repeat-offender-control-specialist-platform`
