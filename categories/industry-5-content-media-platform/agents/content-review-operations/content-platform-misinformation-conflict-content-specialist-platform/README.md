# Misinformation and Conflict Content Specialist (Platform)

A shareable OpenClaw agent folder package for **Misinformation and Conflict Content Specialist (Platform)**.

## Package identity
- Agent ID: `content-platform-misinformation-conflict-content-specialist-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `content-review-operations`
