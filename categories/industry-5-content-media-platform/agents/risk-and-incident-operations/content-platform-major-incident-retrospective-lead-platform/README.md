# Major Incident Retrospective Lead (Platform)

A shareable OpenClaw agent folder package for **Major Incident Retrospective Lead (Platform)**.

## Package identity
- Agent ID: `content-platform-major-incident-retrospective-lead-platform`
- Industry: `industry-5-content-media-platform`
- Role family: `risk-and-incident-operations`
