# Public Sentiment Risk Analyst (Platform)

A shareable OpenClaw agent folder package for **Public Sentiment Risk Analyst (Platform)**.

## Package identity
- Agent ID: `content-platform-public-sentiment-risk-analyst-platform`
