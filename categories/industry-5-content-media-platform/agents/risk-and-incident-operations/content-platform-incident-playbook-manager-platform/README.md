# Incident Playbook Manager (Platform)

A shareable OpenClaw agent folder package for **Incident Playbook Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-incident-playbook-manager-platform`
