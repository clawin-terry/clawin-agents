# Command Center Duty Manager (Platform)

A shareable OpenClaw agent folder package for **Command Center Duty Manager (Platform)**.

## Package identity
- Agent ID: `content-platform-command-center-duty-manager-platform`
